import{c as q,q as i,aU as v,j as o,C as F,a as E,X as I,ad as L,R as _,H as C,u as N,aJ as U,M as H,b as O,S as V,a5 as T,n as B,E as K,_ as J,d as X,e as Z}from"./index-BqcRuPDG.js";import{r as n}from"./react-D_B_6qYb.js";import{u as G}from"./useCurrentPosition-BYw6bfYw.js";import{C as Q}from"./ChatPedidoDialog-DKEQFonH.js";import{s as W}from"./saleUnits-CLP-TCsg.js";import{A as M,a as Y}from"./AuthScreenStyled-b4nnJ2qp.js";import{P as ee,a as oe,b as ae,c as te}from"./PanelLoginDialogStyled-DmHkE5zv.js";import{R as re}from"./refresh-cw-BlZbkEVf.js";import"./send-BhBEfSKT.js";/**
...
`,fe=45e3,me=2e4;function ke(){const{usuario:e}=N(),{status:c,error:h,locate:f}=G(),[t,r]=n.useState(null),[p,b]=n.useState([]),[d,m]=n.useState(null),[y,w]=n.useState(!0),[s,u]=n.useState(null),[l,P]=n.useState(null),g=(e==null?void 0:e.rol)==="fletero",D=g?"fletes":"pedidos",j=n.useCallback(async()=>{try{const{pedidos:a}=await v.disponibles(t==null?void 0:t.lat,t==null?void 0:t.lon);b(a),m(null)}catch(a){m(a instanceof U&&a.status===404?"Esta sección es para repartidores y fleteros aprobados.":`No pudimos cargar los ${D}.`)}finally{w(!1)}},[t,D]);n.useEffect(()=>{f(a=>r(a))},[f]),n.useEffect(()=>{j();const a=window.setInterval(()=>void j(),me);return()=>window.clearInterval(a)},[j]),n.useEffect(()=>{if(!t)return;const a=()=>{v.actualizarUbicacion(t.lat,t.lon).catch(()=>{})};a();const $=window.setInterval(a,fe);return()=>window.clearInterval($)},[t]);const A=async a=>{await v.tomar(a,t==null?void 0:t.lat,t==null?void 0:t.lon);const $=p.find(R=>R.id===a)??null;u(null),await j(),$&&P($)};return o.jsxs(H,{showSearch:!1,children:[o.jsx(O,{children:o.jsx(V,{children:o.jsxs(T,{children:[o.jsx(B,{title:g?"Fletes disponibles":"Pedidos disponibles",chip:y?void 0:`${p.length}`,subtitle:g?"Fletes esperando que alguien los tome.":"Ordenados por cercanía a donde estás."}),d?o.jsx(M,{role:"alert","data-tono":"error",children:d}):null,!t&&c!=="locating"?o.jsxs(ge,{children:[o.jsx(_,{size:16,"aria-hidden":"true"}),o.jsx("span",{children:h??"Sin tu ubicación no podemos ordenarlos por cercanía."}),o.jsxs("button",{type:"button",onClick:()=>f(a=>r(a)),children:[o.jsx(re,{size:14,"aria-hidden":"true"}),"Reintentar"]})]}):null,!y&&p.length===0&&!d?o.jsx(K,{icon:J,title:g?"No hay fletes ahora":"No hay pedidos ahora",text:"Cuando entre uno cerca tuyo lo vas a ver acá.",dashed:!0}):null,p.map(a=>o.jsx(X,{children:o.jsx(Z,{children:o.jsxs(T,{children:[o.jsxs(ce,{children:[o.jsx("span",{children:a.comercio}),typeof a.distanciaKm=="number"?o.jsxs(pe,{children:[a.distanciaKm," km"]}):null]}),o.jsxs(ue,{children:[o.jsxs(k,{children:["Retirás en ",a.comercio_direccion]}),o.jsxs(k,{children:["Entregás en ",a.direccion_texto]}),o.jsxs(k,{"data-suave":!0,children:[a.items," ",a.items===1?"producto":"productos"," ·"," ",C(a.total)]})]}),o.jsxs(he,{type:"button",onClick:()=>u(a.id),children:["Ver detalle ",g?"del flete":"del pedido"]})]})})},a.id))]})})}),o.jsx(de,{open:s!==null,pedidoId:s,onClose:()=>u(null),onTomar:A,esFletero:g}),o.jsx(Q,{open:l!==null,pedidoId:(l==null?void 0:l.id)??null,codigo:(l==null?void 0:l.codigo)??"",cliente:(l==null?void 0:l.cliente)??"",onClose:()=>P(null)})]})}export{ke as PanelRepartidorScreen};
