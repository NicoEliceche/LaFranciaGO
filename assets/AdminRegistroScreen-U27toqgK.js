import{bm as h,j as e,M as I,C as B,S as L,p as O,q as J,E as _}from"./index-DsC-m32S.js";import{r as t}from"./react-6hK8W6IX.js";import{q as a}from"./estilos-DzHAJWDP.js";import{S as P,aL as Z,aa as f,aR as H,a9 as Q,X as U}from"./iconos-DPkufriG.js";const S=a.p`
  margin: 0;
...
`,ir={error:Q,aviso:H,info:f};function k(r){const n=new Date(r.includes("Z")?r:`${r.replace(" ","T")}Z`),i=new Date().toDateString()===n.toDateString();return n.toLocaleString("es-AR",{...i?{}:{day:"2-digit",month:"2-digit"},hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}function gr(){const[r,n]=t.useState([]),[i,C]=t.useState([]),[z,M]=t.useState(0),[D,E]=t.useState([]),[d,p]=t.useState(""),[c,N]=t.useState(""),[b,q]=t.useState(""),[$,A]=t.useState(""),[s,v]=t.useState(null),[R,j]=t.useState(!0),[y,g]=t.useState(null),m=t.useCallback(async()=>{j(!0),g(null);try{const o=await h.ver({nivel:d,area:c,buscar:b});n(o.lineas),C(o.resumen),M(o.total)}catch(o){g(o instanceof Error?o.message:"No pudimos leer el registro.")}finally{j(!1)}},[d,c,b]);t.useEffect(()=>{m()},[m]),t.useEffect(()=>{h.areas().then(o=>E(o.areas)).catch(()=>{})},[]);const F=async o=>{try{const l=await h.linea(o);v(l.linea)}catch{g("No pudimos abrir el detalle.")}},w=o=>{var l;return((l=i.find(T=>T.nivel===o))==null?void 0:l.cuantas)??0};return e.jsxs(I,{showSearch:!1,children:[e.jsx(B,{children:e.jsx(L,{children:e.jsxs(O,{children:[e.jsx(J,{title:"Registro",subtitle:"Qué se rompió, dónde y por qué. Lo último, primero."}),e.jsx(S,{children:"Esta pantalla muestra mensajes internos y cuerpos de peticiones. Es para desarrollo, no para mostrarla a nadie más."}),e.jsxs(X,{children:[e.jsxs(x,{"data-nivel":"error",children:[e.jsx("strong",{children:w("error")}),e.jsx("span",{children:"errores hoy"})]}),e.jsxs(x,{"data-nivel":"aviso",children:[e.jsx("strong",{children:w("aviso")}),e.jsx("span",{children:"avisos hoy"})]}),e.jsxs(x,{children:[e.jsx("strong",{children:z}),e.jsx("span",{children:"líneas guardadas"})]})]}),e.jsxs(G,{onSubmit:o=>{o.preventDefault(),q($.trim())},children:[e.jsx(P,{size:16,"aria-hidden":"true"}),e.jsx("input",{value:$,onChange:o=>A(o.target.value),placeholder:"Buscar en el mensaje, el detalle o la ruta","aria-label":"Buscar en el registro"}),e.jsx("button",{type:"submit",children:"Buscar"}),e.jsx("button",{type:"button",onClick:()=>void m(),"aria-label":"Recargar",children:e.jsx(Z,{size:16,"aria-hidden":"true"})})]}),e.jsxs(K,{children:[e.jsx(u,{type:"button","data-activo":d==="",onClick:()=>p(""),children:"Todo"}),e.jsx(u,{type:"button","data-activo":d==="error",onClick:()=>p("error"),children:"Errores"}),e.jsx(u,{type:"button","data-activo":d==="aviso",onClick:()=>p("aviso"),children:"Avisos"}),D.slice(0,8).map(o=>e.jsxs(u,{type:"button","data-activo":c===o.area,onClick:()=>N(c===o.area?"":o.area),children:[o.area," (",o.cuantas,")"]},o.area))]}),y?e.jsx(S,{role:"alert",children:y}):null,R&&r.length===0?null:r.length===0?e.jsx(_,{icon:f,title:"No hay nada registrado",text:"Cuando algo falle, va a aparecer acá con el detalle de por qué.",dashed:!0}):e.jsx(V,{children:r.map(o=>{const l=ir[o.nivel]??f;return e.jsxs(W,{type:"button","data-nivel":o.nivel,onClick:()=>void F(o.id),children:[e.jsx(l,{size:16,"aria-hidden":"true"}),e.jsxs(Y,{children:[e.jsx(rr,{children:o.mensaje}),e.jsxs(er,{children:[o.metodo?`${o.metodo} `:"",o.ruta??"sin ruta",o.estado?` · ${o.estado}`:"",o.ms!==null?` · ${o.ms} ms`:"",o.area?` · ${o.area}`:""]})]}),e.jsx(or,{children:k(o.creado_en)})]},o.id)})})]})})}),s?e.jsxs(ar,{role:"dialog","aria-label":"Detalle del error",children:[e.jsxs(tr,{children:[e.jsx("span",{children:s.mensaje}),e.jsx(sr,{type:"button",onClick:()=>v(null),"aria-label":"Cerrar",children:e.jsx(U,{size:18,"aria-hidden":"true"})})]}),e.jsxs(nr,{children:[[["Cuándo",k(s.creado_en)],["Dónde",`${s.metodo??""} ${s.ruta??"-"}`.trim()],["Estado",s.estado?String(s.estado):"-"],["Tardó",s.ms!==null?`${s.ms} ms`:"-"],["Área",s.area??"-"],["Usuario",s.usuario_id??"sin sesión"],["IP",s.ip??"-"]].map(([o,l])=>e.jsxs("p",{children:[e.jsx("strong",{children:o}),l]},o)),e.jsx("pre",{children:lr(s.detalle)})]})]}):null]})}function lr(r){if(!r)return"Sin detalle.";try{const n=JSON.parse(r),i=[];return typeof n.stack=="string"&&i.push(n.stack),n.causa&&i.push(`
