import{j as o,Q as ae,R as oe,T as re,U as ie,r as M,V as ge,W as me,X as ue,Y as be,h as he,Z as fe,u as ye,_ as xe,$ as $e,M as we,a0 as F,S as A,a1 as je,a2 as ve,a3 as ke,a4 as Ce,a5 as Se,G as V,p as ze,q as _,E as Pe,a6 as Le,a as q,d as Ie}from"./index-CieFfyMG.js";import{r as l,L as Me,h as qe,d as Be}from"./react-6hK8W6IX.js";import{p as Fe,m as Y,s as G,a as Ae}from"./saleUnits-CLP-TCsg.js";import{q as r,A as Ee}from"./estilos-DzHAJWDP.js";import{P as Oe,a2 as He,C as Te,t as Re,a3 as Ue,M as Ne,h as De,S as Qe,O as Ve,m as _e}from"./iconos-DPkufriG.js";import{a as Ye}from"./cartStore-0fSA2Xh5.js";const Ge=r.article`
  display: flex;
...
`,C=1;function X({name:e,price:n,saleUnit:c,categoryId:x,badge:d,quantity:h,onAdd:v,priority:f}){const[b,p]=l.useState(C),[u,k]=l.useState(!1),g=()=>{v(b),p(C),k(!0),window.setTimeout(()=>k(!1),1400)};return o.jsxs(Ge,{"data-active":h>0,children:[o.jsxs(ae,{$ratio:"1 / 1",children:[o.jsx(oe,{src:re(x),alt:e,loading:f?"eager":"lazy"}),d?o.jsx(ie,{children:o.jsx(ea,{children:d})}):null]}),o.jsxs(We,{children:[o.jsx(Xe,{children:e}),o.jsxs(Je,{children:[o.jsxs(Ke,{children:[o.jsx(Ze,{children:M(n)}),c&&c!=="unidad"?o.jsx(ta,{children:Fe(c)}):null]}),o.jsxs(aa,{children:[o.jsx(W,{type:"button",onClick:()=>p(y=>Math.min(y+1,Y(c)+C)),disabled:b-C>=Y(c),"aria-label":`Agregar cantidad de ${e}`,children:o.jsx(Oe,{size:15,"aria-hidden":"true"})}),o.jsx(oa,{"aria-live":"polite",children:G(c,b-C)}),o.jsx(W,{type:"button",onClick:()=>p(y=>Math.max(C,y-1)),disabled:b<=C,"aria-label":`Quitar cantidad de ${e}`,children:o.jsx(He,{size:15,"aria-hidden":"true"})})]})]}),o.jsx(ra,{type:"button",onClick:g,"data-added":u,children:u?o.jsxs(o.Fragment,{children:[o.jsx(Te,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),h>0?o.jsxs(ia,{children:[G(c,h-C)," en el pedido"]}):null]})]})}const sa=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
...
`;r(q)`
  border-style: dashed;
`;const Ia=e=>Z[e]??Z[za];function Ha(){var Q;const{storeId:e=""}=qe(),[n,c]=Be(),{stores:x}=ye(),d=l.useMemo(()=>x.find(a=>a.id===e)??xe(e)??x[0],[e,x]),{secciones:h,cargando:v}=ba(e),f=l.useMemo(()=>({intro:(d==null?void 0:d.summary)??"",sections:h.length>0?h:Ia(e).sections}),[h,d,e]),b=n.get("pedido"),p=l.useMemo(()=>b?$e.find(a=>a.id===b&&a.storeId===d.id)??null:null,[b,d.id]),u=l.useMemo(()=>{if(!p)return f;const a=new Set(p.items.map(i=>i.productId));return{...f,sections:f.sections.map(i=>({...i,products:i.products.filter(s=>a.has(s.id))})).filter(i=>i.products.length>0)}},[f,p]),k=l.useMemo(()=>p?Object.fromEntries(p.items.map(a=>[a.productId,a.quantity])):{},[p]),g=l.useMemo(()=>u.sections.flatMap(a=>a.products),[u]),[y,z]=l.useState(""),[t,m]=l.useState("all"),[$,j]=l.useState(((Q=g[0])==null?void 0:Q.id)??""),[w,O]=l.useState({});l.useEffect(()=>{var i;const a=Object.fromEntries(g.map(s=>[s.id,0]));z(""),m("all"),j(((i=g[0])==null?void 0:i.id)??""),O(a)},[g,d.id]);const H=n.get("oferta"),T=l.useRef(null);l.useEffect(()=>{if(!H||v)return;const a=T.current;if(!a)return;const i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=window.requestAnimationFrame(()=>{a.scrollIntoView({behavior:i?"auto":"smooth",block:"start"})});return()=>window.cancelAnimationFrame(s)},[v,H,d.id]);const I=l.useMemo(()=>{const a=y.trim();return u.sections.filter(i=>t==="all"||i.id===t).map(i=>({...i,products:i.products.filter(s=>Ma(a,i,s))})).filter(i=>i.products.length>0)},[t,u,y]),S=l.useMemo(()=>I.flatMap(a=>a.products),[I]);l.useEffect(()=>{S.length!==0&&(S.some(a=>a.id===$)||j(S[0].id))},[$,S]);const B=l.useMemo(()=>S.find(a=>a.id===$)??S[0]??g[0],[g,$,S]),R=l.useMemo(()=>!B||p?[]:B.suggestions.map(a=>g.find(i=>i.id===a)).filter(a=>!!a).slice(0,4),[g,B]),P=l.useMemo(()=>Object.values(w).filter(a=>a>0).length,[w]),se=l.useMemo(()=>g.reduce((a,i)=>{const s=w[i.id]??0;return s<=0?a:a+Math.round(i.price*Ae(i.saleUnit,s-1))},0),[g,w]),U=l.useRef(null),[ne,N]=l.useState(0);l.useLayoutEffect(()=>{const a=U.current;if(!a){N(0);return}const i=new ResizeObserver(()=>{const s=Number.parseFloat(getComputedStyle(a).bottom)||0;N(a.offsetHeight+s)});return i.observe(a),()=>i.disconnect()},[P]),l.useMemo(()=>g.map(a=>({...a,quantity:w[a.id]??0})).filter(a=>a.quantity>0).sort((a,i)=>i.quantity-a.quantity).slice(0,3),[g,w]),l.useMemo(()=>{const a=y.trim().toLowerCase(),i=a?u.sections.filter(s=>s.label.toLowerCase().includes(a)||s.description.toLowerCase().includes(a)):u.sections;return i.length>0?i.slice(0,3):u.sections.slice(0,3)},[u.sections,y]);const de=()=>{const a=new URLSearchParams(n);a.delete("pedido"),c(a,{replace:!0})},le=a=>{a.preventDefault()},ce=(a,i)=>{O(s=>{const L=Math.max(0,(s[a]??0)+i);return{...s,[a]:L}}),j(a)},D=(a,i=1)=>{const s=g.find(L=>L.id===a);s&&(Ye({id:s.id,product:s.name,store:d.name,storeId:d.id,categoryId:s.categoryId,price:s.price,saleUnit:s.saleUnit,tamano:s.tamano},i),ce(a,i))};return o.jsxs(we,{showSearch:!1,children:[o.jsx(F,{children:o.jsx(A,{children:o.jsx(ua,{id:d.id,name:d.name,category:d.category,categoryId:d.id,address:d.address,hours:d.hours,distanceKm:d.distanceKm,rating:d.rating,openNow:d.openNow,minOrder:d.minOrder})})}),o.jsx(F,{children:o.jsx(A,{children:o.jsxs(Pa,{children:[p?o.jsxs(ja,{children:[o.jsx(De,{size:20,"aria-hidden":"true"}),o.jsxs(va,{children:[o.jsxs(ka,{children:["Productos del pedido ",p.code]}),o.jsxs(Ca,{children:[p.date," · ",M(p.total)]})]}),o.jsx(Sa,{type:"button",onClick:de,children:"Ver todo el comercio"})]}):null,o.jsx(je,{onSubmit:le,children:o.jsxs(ve,{htmlFor:"store-search",children:[o.jsx(ke,{children:"Buscar productos dentro del comercio"}),o.jsxs(Ce,{children:[o.jsx(Qe,{size:18,"aria-hidden":"true"}),o.jsx(Se,{id:"store-search",value:y,onChange:a=>z(a.target.value),placeholder:`Buscar en ${d.name}...`,"aria-label":"Buscar productos dentro del comercio"})]})]})}),o.jsxs(V,{"aria-label":"Categorías del comercio",children:[o.jsx(ee,{type:"button","data-active":t==="all",onClick:()=>m("all"),children:"Todas"}),u.sections.map(a=>o.jsx(ee,{type:"button","data-active":t===a.id,onClick:()=>m(a.id),children:a.label},a.id))]}),I.length>0?I.map((a,i)=>o.jsxs(ze,{ref:a.id===te?T:void 0,children:[o.jsx(_,{title:a.label,subtitle:a.description}),o.jsx(La,{children:a.products.map((s,L)=>o.jsx(X,{name:s.name,price:s.price,saleUnit:s.saleUnit,categoryId:s.categoryId,badge:p?`${k[s.id]??1} u.`:s.badge,quantity:w[s.id]??0,onAdd:pe=>D(s.id,pe),priority:i===0&&L<4},s.id))})]},a.id)):o.jsx(Pe,{icon:Ve,title:"Sin resultados",text:"Probá con otro término o cambiá de categoría.",dashed:!0})]})})}),R.length>0&&o.jsx(F,{children:o.jsxs(A,{children:[o.jsx(_,{title:"También podés llevar",chip:"Sugeridos",subtitle:"Combinaciones que van con lo que estás pidiendo."}),o.jsx(V,{as:Le,"aria-label":"Productos sugeridos",children:R.map(a=>o.jsx(X,{name:a.name,price:a.price,categoryId:a.categoryId,badge:a.badge,quantity:w[a.id]??0,onAdd:i=>D(a.id,i)},a.id))})]})}),P>0&&o.jsx(fa,{style:{height:ne}}),P>0&&o.jsxs(ha,{ref:U,children:[o.jsxs(ya,{children:[o.jsxs(xa,{children:[P," ",P===1?"producto":"productos"]}),o.jsx($a,{children:M(se)})]}),o.jsxs(wa,{to:"/carrito",children:[o.jsx(_e,{size:18,"aria-hidden":"true"}),"Ver carrito"]})]})]})}r.span`
  display: inline-flex;
  align-items: center;
  min-height: 1.5rem;
  ...
  text-transform: uppercase;
`;function Ma(e,n,c){if(!e)return!0;const x=e.toLowerCase();return[n.label,n.description,c.name,c.description,c.categoryLabel].join(" ").toLowerCase().includes(x)}export{Ha as StoreProfileScreen};
