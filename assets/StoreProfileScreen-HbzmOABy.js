import{q as r,j as a,W as J,Y as K,Z as X,_ as Z,n as I,$ as te,o as se,a0 as ne,a1 as de,a2 as le,a3 as ce,a4 as pe,r as ge,h as me,a5 as ue,a6 as be,t as he,a7 as fe,a8 as ye,M as xe,a9 as B,S as F,P as $e,aa as we,ab as je,ac as ke,ad as ve,ae as Ce,af as ze,I as U,l as Se,m as D,E as Pe,D as Ie,ag as Le,ah as Me,d as L,a as qe}from"./index-BYdsqWK_.js";import{r as l,L as Be,h as Fe,f as Ae}from"./react-D_B_6qYb.js";import{p as Ee,s as N,m as R}from"./saleUnits-CLP-TCsg.js";import{M as He,a as Te}from"./cartStore-Bjt9NcqQ.js";import{C as Oe}from"./clock-3-r5zXbbvB.js";const Ue=r.article`
  display: flex;
...
`,Je=r.span`
  ...
  font-size: ${({theme:e})=>e.typography.size.xs};
  font-weight: ${({theme:e})=>e.typography.weight.semibold};
`,C=1;function V({name:e,price:s,saleUnit:p,categoryId:h,badge:n,quantity:b,onAdd:f,priority:y}){const[c,m]=l.useState(C),[j,g]=l.useState(!1),$=()=>{f(c),m(C),g(!0),window.setTimeout(()=>g(!1),1400)};return a.jsxs(Ue,{"data-active":b>0,children:[a.jsxs(J,{$ratio:"1 / 1",children:[a.jsx(K,{src:X(h),alt:e,loading:y?"eager":"lazy"}),n?a.jsx(Z,{children:a.jsx(Ve,{children:n})}):null]}),a.jsxs(De,{children:[a.jsx(Ne,{children:e}),a.jsxs(Re,{children:[a.jsxs(Qe,{children:[I(s),p&&p!=="unidad"?a.jsxs(Je,{children:[" ",Ee(p)]}):null]}),a.jsxs(Ye,{children:[a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.max(C,w-1)),disabled:c<=C,"aria-label":`Quitar cantidad de ${e}`,children:a.jsx(He,{size:16,"aria-hidden":"true"})}),a.jsx(_e,{"aria-live":"polite",children:N(p,c-C)}),a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.min(w+1,R(p)+C)),disabled:c-C>=R(p),"aria-label":`Agregar cantidad de ${e}`,children:a.jsx(te,{size:16,"aria-hidden":"true"})})]})]}),a.jsx(We,{type:"button",onClick:$,"data-added":j,children:j?a.jsxs(a.Fragment,{children:[a.jsx(se,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),b>0?a.jsxs(Ge,{children:[N(p,b-C)," en el pedido"]}):null]})]})}const Ke=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
