import{q as e,Q as p,ag as h,j as t,ad as u}from"./index-B4Hw2TNB.js";import{L as f}from"./react-D_B_6qYb.js";const x=e.div`
...
`,S=e.span`
  ...
  flex: 0 0 auto;
  color: ${({theme:o})=>o.color.textSoft};
`;function v({icon:o,title:c,subtitle:r,to:i,onClick:s,tone:a,trailing:g}){const n=t.jsxs(t.Fragment,{children:[t.jsx($,{"data-tone":a??"default",children:t.jsx(o,{size:18,"aria-hidden":"true"})}),t.jsxs(w,{children:[t.jsx(y,{"data-tone":a??"default",children:c}),r?t.jsx(b,{children:r}):null]}),g??t.jsx(S,{children:t.jsx(u,{size:18,"aria-hidden":"true"})})]});return i?t.jsx(m,{to:i,children:n}):s?t.jsx(d,{as:"button",type:"button",onClick:s,children:n}):t.jsx(d,{children:n})}function k({children:o}){return t.jsx(x,{children:o})}export{k as S,v as a};
