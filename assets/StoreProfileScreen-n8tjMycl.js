import{q as r,j as a,Y as K,Z as W,_ as X,$ as Z,o as L,a0 as te,p as se,a1 as ne,a2 as de,a3 as le,a4 as ce,a5 as pe,t as ge,h as me,a6 as ue,a7 as be,v as he,a8 as fe,a9 as ye,M as xe,aa as B,S as F,P as $e,ab as we,ac as je,ad as ke,ae as ve,af as Ce,ag as ze,J as U,m as Se,n as D,E as Pe,F as Le,ah as Ie,ai as Me,d as I,a as qe}from"./index-CQSQA-do.js";import{r as l,L as Be,h as Fe,f as Ae}from"./react-D_B_6qYb.js";import{p as Ee,s as N,m as R}from"./saleUnits-CLP-TCsg.js";import{M as He,a as Te}from"./cartStore-B8HKfZyJ.js";import{C as Oe}from"./clock-3-DHwDr4kB.js";const Ue=r.article`
  display: flex;
...
`,Ke=r.span`
  ...
  font-size: ${({theme:e})=>e.typography.size.xs};
  font-weight: ${({theme:e})=>e.typography.weight.semibold};
`,C=1;function V({name:e,price:s,saleUnit:p,categoryId:h,badge:n,quantity:b,onAdd:f,priority:y}){const[c,m]=l.useState(C),[j,g]=l.useState(!1),$=()=>{f(c),m(C),g(!0),window.setTimeout(()=>g(!1),1400)};return a.jsxs(Ue,{"data-active":b>0,children:[a.jsxs(K,{$ratio:"1 / 1",children:[a.jsx(W,{src:X(h),alt:e,loading:y?"eager":"lazy"}),n?a.jsx(Z,{children:a.jsx(Ve,{children:n})}):null]}),a.jsxs(De,{children:[a.jsx(Ne,{children:e}),a.jsxs(Re,{children:[a.jsxs(Qe,{children:[L(s),p&&p!=="unidad"?a.jsxs(Ke,{children:[" ",Ee(p)]}):null]}),a.jsxs(Ye,{children:[a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.max(C,w-1)),disabled:c<=C,"aria-label":`Quitar cantidad de ${e}`,children:a.jsx(He,{size:16,"aria-hidden":"true"})}),a.jsx(_e,{"aria-live":"polite",children:N(p,c-C)}),a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.min(w+1,R(p)+C)),disabled:c-C>=R(p),"aria-label":`Agregar cantidad de ${e}`,children:a.jsx(te,{size:16,"aria-hidden":"true"})})]})]}),a.jsx(Je,{type:"button",onClick:$,"data-added":j,children:j?a.jsxs(a.Fragment,{children:[a.jsx(se,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),b>0?a.jsxs(Ge,{children:[N(p,b-C)," en el pedido"]}):null]})]})}const We=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
