import{q as r,j as a,l as E,n as T,o as D,p as O,t as L,v as U,w as V,x as Y,A as K,y as G,z as J,B as W,D as X,G as _,s as Z,H as ee,M as ae,I as C,a as z,J as oe,K as re,L as ie,N as te,O as se,Q as ne,R as de,e as B,E as le,k as ce,T as pe,U as ge,V as w,W as me}from"./index-CEnDCpoj.js";import{r as n,L as ue,e as be}from"./react-Clk3ySf9.js";import{M as he}from"./minus-DET3v042.js";import{C as ye}from"./clock-3-CkPZ94lo.js";import{S as fe}from"./ScrollRail-C5HkSyGl.js";const xe=r.article`
  display: flex;
...
`,Le=r.span`
  ...
  text-align: center;
`,$=1;function F({name:e,price:i,categoryId:d,badge:s,quantity:c,onAdd:f,priority:m}){const[u,p]=n.useState($),[b,g]=n.useState(!1),x=()=>{f(u),p($),g(!0),window.setTimeout(()=>g(!1),1400)};return a.jsxs(xe,{"data-active":c>0,children:[a.jsxs(E,{$ratio:"1 / 1",children:[a.jsx(T,{src:D(d),alt:e,loading:m?"eager":"lazy"}),s?a.jsx(O,{children:a.jsx(ve,{children:s})}):null]}),a.jsxs($e,{children:[a.jsx(we,{children:e}),a.jsxs(je,{children:[a.jsx(ke,{children:L(i)}),a.jsxs(Ce,{children:[a.jsx(q,{type:"button",onClick:()=>p(h=>Math.max($,h-1)),disabled:u<=$,"aria-label":`Quitar una unidad de ${e}`,children:a.jsx(he,{size:16,"aria-hidden":"true"})}),a.jsx(ze,{"aria-live":"polite",children:u}),a.jsx(q,{type:"button",onClick:()=>p(h=>h+1),"aria-label":`Agregar una unidad de ${e}`,children:a.jsx(U,{size:16,"aria-hidden":"true"})})]})]}),a.jsx(Se,{type:"button",onClick:x,"data-added":b,children:b?a.jsxs(a.Fragment,{children:[a.jsx(V,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),c>0?a.jsxs(Le,{children:[c," ",c===1?"unidad":"unidades"," en el pedido"]}):null]})]})}const Pe=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
...
`,Ae=r.span`
  ...
  font-weight: ${({theme:e})=>e.typography.weight.bold};
  box-shadow: ${({theme:e})=>e.shadow.sm};
`;function Ee({id:e,name:i,category:d,categoryId:s,address:c,hours:f,distanceKm:m,rating:u,openNow:p,minOrder:b}){return a.jsxs(Pe,{children:[a.jsxs(E,{$ratio:"21 / 9",children:[a.jsx(T,{src:D(s),alt:d,loading:"eager"}),a.jsxs(O,{children:[a.jsx(He,{"data-open":p,children:p?"Abierto ahora":"Cerrado"}),a.jsxs(Ae,{children:[a.jsx(Y,{size:13,"aria-hidden":"true",fill:"currentColor"}),u.toFixed(1)]})]}),a.jsx(Ie,{children:a.jsx(K,{$size:"3.5rem",$tone:J(e),children:G(i)})})]}),a.jsxs(Me,{children:[a.jsx(Be,{children:i}),a.jsxs(qe,{children:[d," · ",W(m)]}),a.jsxs(Fe,{children:[a.jsxs(S,{children:[a.jsx(ye,{size:14,"aria-hidden":"true"}),f]}),a.jsxs(S,{children:[a.jsx(X,{size:14,"aria-hidden":"true"}),c]}),a.jsxs(S,{children:["Mínimo ",L(b)]})]})]})]})}r.div`
  display: grid;
...
`;r(w)`
  overflow: hidden;
  border-color: ${({theme:e,$active:i})=>i?"rgba(0, 71, 231, 0.24)":e.color.border};
  background: ${({theme:e,$active:i})=>i?e.mode==="dark"?"linear-gradient(180deg, rgba(107, 157, 255, 0.09), rgba(17, 26, 46, 0.98))":"linear-gradient(180deg, rgba(0, 71, 231, 0.05), rgba(255, 255, 255, 0.98))":e.color.surface};
  box-shadow: ${({theme:e,$active:i})=>i?e.shadow.md:e.shadow.sm};
`;r.div`
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`;r(w)`
  border-style: dashed;
`;const Ye=e=>H[e]??H[Ne];function Ze(){var M;const{storeId:e=""}=be(),i=n.useMemo(()=>ee(e)??Z[0],[e]),d=n.useMemo(()=>Ye(i.id),[i.id]),s=n.useMemo(()=>d.sections.flatMap(o=>o.products),[d]),[c,f]=n.useState(""),[m,u]=n.useState("all"),[p,b]=n.useState(((M=s[0])==null?void 0:M.id)??""),[g,x]=n.useState({});n.useEffect(()=>{var t;const o=Object.fromEntries(s.map(l=>[l.id,0]));f(""),u("all"),b(((t=s[0])==null?void 0:t.id)??""),x(o)},[s,i.id]);const h=n.useMemo(()=>{const o=c.trim();return d.sections.filter(t=>m==="all"||t.id===m).map(t=>({...t,products:t.products.filter(l=>Ke(o,t,l))})).filter(t=>t.products.length>0)},[m,d,c]),y=n.useMemo(()=>h.flatMap(o=>o.products),[h]);n.useEffect(()=>{y.length!==0&&(y.some(o=>o.id===p)||b(y[0].id))},[p,y]);const j=n.useMemo(()=>y.find(o=>o.id===p)??y[0]??s[0],[s,p,y]),P=n.useMemo(()=>j?j.suggestions.map(o=>s.find(t=>t.id===o)).filter(o=>!!o).slice(0,4):[],[s,j]),k=n.useMemo(()=>Object.values(g).reduce((o,t)=>o+t,0),[g]),R=n.useMemo(()=>s.reduce((o,t)=>o+t.price*(g[t.id]??0),0),[s,g]);n.useMemo(()=>s.map(o=>({...o,quantity:g[o.id]??0})).filter(o=>o.quantity>0).sort((o,t)=>t.quantity-o.quantity).slice(0,3),[s,g]),n.useMemo(()=>{const o=c.trim().toLowerCase(),t=o?d.sections.filter(l=>l.label.toLowerCase().includes(o)||l.description.toLowerCase().includes(o)):d.sections;return t.length>0?t.slice(0,3):d.sections.slice(0,3)},[d.sections,c]);const Q=o=>{o.preventDefault()},I=(o,t)=>{x(l=>{const v=Math.max(0,(l[o]??0)+t);return{...l,[o]:v}}),b(o)};return a.jsxs(ae,{showSearch:!1,children:[a.jsx(C,{children:a.jsx(z,{children:a.jsx(Ee,{id:i.id,name:i.name,category:i.category,categoryId:i.id,address:i.address,hours:i.hours,distanceKm:i.distanceKm,rating:i.rating,openNow:i.openNow,minOrder:i.minOrder})})}),a.jsx(C,{children:a.jsx(z,{children:a.jsxs(Ue,{children:[a.jsx(oe,{onSubmit:Q,children:a.jsxs(re,{htmlFor:"store-search",children:[a.jsx(ie,{children:"Buscar productos dentro del comercio"}),a.jsxs(te,{children:[a.jsx(se,{size:18,"aria-hidden":"true"}),a.jsx(ne,{id:"store-search",value:c,onChange:o=>f(o.target.value),placeholder:`Buscar en ${i.name}...`,"aria-label":"Buscar productos dentro del comercio"})]})]})}),a.jsxs(fe,{"aria-label":"Categorías del comercio",children:[a.jsx(A,{type:"button","data-active":m==="all",onClick:()=>u("all"),children:"Todas"}),d.sections.map(o=>a.jsx(A,{type:"button","data-active":m===o.id,onClick:()=>u(o.id),children:o.label},o.id))]}),h.length>0?h.map((o,t)=>a.jsxs(de,{children:[a.jsx(B,{title:o.label,subtitle:o.description}),a.jsx(Ve,{children:o.products.map((l,v)=>a.jsx(F,{name:l.name,price:l.price,categoryId:l.categoryId,badge:l.badge,quantity:g[l.id]??0,onAdd:N=>I(l.id,N),priority:t===0&&v<4},l.id))})]},o.id)):a.jsx(le,{icon:ce,title:"Sin resultados",text:"Probá con otro término o cambiá de categoría.",dashed:!0})]})})}),P.length>0&&a.jsx(C,{children:a.jsxs(z,{children:[a.jsx(B,{title:"También podés llevar",chip:"Sugeridos",subtitle:"Combinaciones que van con lo que estás pidiendo."}),a.jsx(pe,{"aria-label":"Productos sugeridos",children:P.map(o=>a.jsx(F,{name:o.name,price:o.price,categoryId:o.categoryId,badge:o.badge,quantity:g[o.id]??0,onAdd:t=>I(o.id,t)},o.id))})]})}),k>0&&a.jsxs(Te,{children:[a.jsxs(De,{children:[a.jsxs(Oe,{children:[k," ",k===1?"producto":"productos"]}),a.jsx(Re,{children:L(R)})]}),a.jsxs(Qe,{to:"/carrito",children:[a.jsx(ge,{size:18,"aria-hidden":"true"}),"Ver carrito"]})]})]})}r.span`
  display: inline-flex;
  align-items: center;
  min-height: 1.5rem;
  ...
  text-transform: uppercase;
`;function Ke(e,i,d){if(!e)return!0;const s=e.toLowerCase();return[i.label,i.description,d.name,d.description,d.categoryLabel].join(" ").toLowerCase().includes(s)}export{Ze as StoreProfileScreen};
