import{q as r,j as a,n as T,o as D,p as O,t as R,v as L,w as V,x as Y,y as K,A as G,z as J,B as X,D as W,G as _,H as Z,s as ee,I as ae,M as oe,J as C,a as z,K as re,L as ie,N as te,O as se,Q as ne,R as de,d as B,T as le,f as q,E as ce,l as pe,U as ge,V as me,W as w,X as ue}from"./index-CbhpU_zf.js";import{r as n,L as be,e as he}from"./react-Clk3ySf9.js";import{M as ye}from"./minus-C9dB0aGE.js";import{C as fe}from"./clock-3-CSG0s5UM.js";const xe=r.article`
  display: flex;
...
`,Le=r.span`
  ...
  text-align: center;
`,$=1;function H({name:e,price:i,categoryId:d,badge:s,quantity:c,onAdd:f,priority:m}){const[u,p]=n.useState($),[b,g]=n.useState(!1),x=()=>{f(u),p($),g(!0),window.setTimeout(()=>g(!1),1400)};return a.jsxs(xe,{"data-active":c>0,children:[a.jsxs(T,{$ratio:"1 / 1",children:[a.jsx(D,{src:O(d),alt:e,loading:m?"eager":"lazy"}),s?a.jsx(R,{children:a.jsx(ve,{children:s})}):null]}),a.jsxs($e,{children:[a.jsx(we,{children:e}),a.jsxs(je,{children:[a.jsx(ke,{children:L(i)}),a.jsxs(Ce,{children:[a.jsx(F,{type:"button",onClick:()=>p(h=>Math.max($,h-1)),disabled:u<=$,"aria-label":`Quitar una unidad de ${e}`,children:a.jsx(ye,{size:16,"aria-hidden":"true"})}),a.jsx(ze,{"aria-live":"polite",children:u}),a.jsx(F,{type:"button",onClick:()=>p(h=>h+1),"aria-label":`Agregar una unidad de ${e}`,children:a.jsx(V,{size:16,"aria-hidden":"true"})})]})]}),a.jsx(Se,{type:"button",onClick:x,"data-added":b,children:b?a.jsxs(a.Fragment,{children:[a.jsx(Y,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),c>0?a.jsxs(Le,{children:[c," ",c===1?"unidad":"unidades"," en el pedido"]}):null]})]})}const Pe=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
...
`,Ae=r.span`
  ...
  font-weight: ${({theme:e})=>e.typography.weight.bold};
  box-shadow: ${({theme:e})=>e.shadow.sm};
`;function Ee({id:e,name:i,category:d,categoryId:s,address:c,hours:f,distanceKm:m,rating:u,openNow:p,minOrder:b}){return a.jsxs(Pe,{children:[a.jsxs(T,{$ratio:"21 / 9",children:[a.jsx(D,{src:O(s),alt:d,loading:"eager"}),a.jsxs(R,{children:[a.jsx(He,{"data-open":p,children:p?"Abierto ahora":"Cerrado"}),a.jsxs(Ae,{children:[a.jsx(K,{size:13,"aria-hidden":"true",fill:"currentColor"}),u.toFixed(1)]})]}),a.jsx(Ie,{children:a.jsx(G,{$size:"3.5rem",$tone:X(e),children:J(i)})})]}),a.jsxs(Me,{children:[a.jsx(Be,{children:i}),a.jsxs(qe,{children:[d," · ",W(m)]}),a.jsxs(Fe,{children:[a.jsxs(S,{children:[a.jsx(fe,{size:14,"aria-hidden":"true"}),f]}),a.jsxs(S,{children:[a.jsx(_,{size:14,"aria-hidden":"true"}),c]}),a.jsxs(S,{children:["Mínimo ",L(b)]})]})]})]})}r.div`
  display: grid;
...
`;r(w)`
  border-style: dashed;
`;const Ye=e=>A[e]??A[Ne];function _e(){var M;const{storeId:e=""}=he(),i=n.useMemo(()=>ae(e)??ee[0],[e]),d=n.useMemo(()=>Ye(i.id),[i.id]),s=n.useMemo(()=>d.sections.flatMap(o=>o.products),[d]),[c,f]=n.useState(""),[m,u]=n.useState("all"),[p,b]=n.useState(((M=s[0])==null?void 0:M.id)??""),[g,x]=n.useState({});n.useEffect(()=>{var t;const o=Object.fromEntries(s.map(l=>[l.id,0]));f(""),u("all"),b(((t=s[0])==null?void 0:t.id)??""),x(o)},[s,i.id]);const h=n.useMemo(()=>{const o=c.trim();return d.sections.filter(t=>m==="all"||t.id===m).map(t=>({...t,products:t.products.filter(l=>Ke(o,t,l))})).filter(t=>t.products.length>0)},[m,d,c]),y=n.useMemo(()=>h.flatMap(o=>o.products),[h]);n.useEffect(()=>{y.length!==0&&(y.some(o=>o.id===p)||b(y[0].id))},[p,y]);const j=n.useMemo(()=>y.find(o=>o.id===p)??y[0]??s[0],[s,p,y]),P=n.useMemo(()=>j?j.suggestions.map(o=>s.find(t=>t.id===o)).filter(o=>!!o).slice(0,4):[],[s,j]),k=n.useMemo(()=>Object.values(g).reduce((o,t)=>o+t,0),[g]),Q=n.useMemo(()=>s.reduce((o,t)=>o+t.price*(g[t.id]??0),0),[s,g]);n.useMemo(()=>s.map(o=>({...o,quantity:g[o.id]??0})).filter(o=>o.quantity>0).sort((o,t)=>t.quantity-o.quantity).slice(0,3),[s,g]),n.useMemo(()=>{const o=c.trim().toLowerCase(),t=o?d.sections.filter(l=>l.label.toLowerCase().includes(o)||l.description.toLowerCase().includes(o)):d.sections;return t.length>0?t.slice(0,3):d.sections.slice(0,3)},[d.sections,c]);const N=o=>{o.preventDefault()},I=(o,t)=>{x(l=>{const v=Math.max(0,(l[o]??0)+t);return{...l,[o]:v}}),b(o)};return a.jsxs(oe,{showSearch:!1,children:[a.jsx(C,{children:a.jsx(z,{children:a.jsx(Ee,{id:i.id,name:i.name,category:i.category,categoryId:i.id,address:i.address,hours:i.hours,distanceKm:i.distanceKm,rating:i.rating,openNow:i.openNow,minOrder:i.minOrder})})}),a.jsx(C,{children:a.jsx(z,{children:a.jsxs(Ue,{children:[a.jsx(re,{onSubmit:N,children:a.jsxs(ie,{htmlFor:"store-search",children:[a.jsx(te,{children:"Buscar productos dentro del comercio"}),a.jsxs(se,{children:[a.jsx(ne,{size:18,"aria-hidden":"true"}),a.jsx(de,{id:"store-search",value:c,onChange:o=>f(o.target.value),placeholder:`Buscar en ${i.name}...`,"aria-label":"Buscar productos dentro del comercio"})]})]})}),a.jsxs(B,{"aria-label":"Categorías del comercio",children:[a.jsx(E,{type:"button","data-active":m==="all",onClick:()=>u("all"),children:"Todas"}),d.sections.map(o=>a.jsx(E,{type:"button","data-active":m===o.id,onClick:()=>u(o.id),children:o.label},o.id))]}),h.length>0?h.map((o,t)=>a.jsxs(le,{children:[a.jsx(q,{title:o.label,subtitle:o.description}),a.jsx(Ve,{children:o.products.map((l,v)=>a.jsx(H,{name:l.name,price:l.price,categoryId:l.categoryId,badge:l.badge,quantity:g[l.id]??0,onAdd:U=>I(l.id,U),priority:t===0&&v<4},l.id))})]},o.id)):a.jsx(ce,{icon:pe,title:"Sin resultados",text:"Probá con otro término o cambiá de categoría.",dashed:!0})]})})}),P.length>0&&a.jsx(C,{children:a.jsxs(z,{children:[a.jsx(q,{title:"También podés llevar",chip:"Sugeridos",subtitle:"Combinaciones que van con lo que estás pidiendo."}),a.jsx(B,{as:ge,"aria-label":"Productos sugeridos",children:P.map(o=>a.jsx(H,{name:o.name,price:o.price,categoryId:o.categoryId,badge:o.badge,quantity:g[o.id]??0,onAdd:t=>I(o.id,t)},o.id))})]})}),k>0&&a.jsxs(Te,{children:[a.jsxs(De,{children:[a.jsxs(Oe,{children:[k," ",k===1?"producto":"productos"]}),a.jsx(Re,{children:L(Q)})]}),a.jsxs(Qe,{to:"/carrito",children:[a.jsx(me,{size:18,"aria-hidden":"true"}),"Ver carrito"]})]})]})}r.span`
  display: inline-flex;
  align-items: center;
  min-height: 1.5rem;
  ...
  text-transform: uppercase;
`;function Ke(e,i,d){if(!e)return!0;const s=e.toLowerCase();return[i.label,i.description,d.name,d.description,d.categoryLabel].join(" ").toLowerCase().includes(s)}export{_e as StoreProfileScreen};
