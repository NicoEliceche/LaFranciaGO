const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AddressMap-sdpJLZGd.js","assets/react-D_B_6qYb.js","assets/AddressMapStyled-BN5sDOPB.js","assets/AddressMapStyled-CIGW-MKW.css","assets/useCurrentPosition-BYw6bfYw.js","assets/AuthScreen-CDXarh1G.js","assets/formStyles-jkzbJ40R.js","assets/AuthScreenStyled-klYjJbHP.js","assets/PanelLoginDialogStyled-By71U9PN.js","assets/mail-CXO81BVo.js","assets/shield-check-k5bsnxJD.js","assets/log-in-D7zMxHVJ.js","assets/CategoriesScreen-DuMtXs-f.js","assets/StoresDirectoryScreen-9HcA-_EJ.js","assets/StoreProfileScreen-CUresjry.js","assets/saleUnits-CLP-TCsg.js","assets/minus-DgS2s8aC.js","assets/clock-3-GA_lhQfm.js","assets/ProductDetailScreen-D8W5bHFf.js","assets/SettingsList-Aq2OtwvO.js","assets/MyOrdersScreen-BulgjUuW.js","assets/ordersStore-DaJrrmy5.js","assets/CartScreen-BrT-17tH.js","assets/ConfirmDialog-CM-SX8st.js","assets/ErrandScreen-DK6BRTnr.js","assets/errandStore-Bion9qKH.js","assets/ErrandChatScreen-DIxSE3fk.js","assets/mediaService-D2_VAu2k.js","assets/camera-CAEXN7IP.js","assets/send-BlkFWj-e.js","assets/FavoritesScreen-B-t1RXOM.js","assets/NotificationsScreen-BTTCDNkr.js","assets/badge-percent-dqaFeIW7.js","assets/CustomerAccountScreen-BCqINIS2.js","assets/phone-PqtPU169.js","assets/CommerceRegistrationScreen-WaKfnW8I.js","assets/useMediaUpload-CTMFYLii.js","assets/FileField-B5MjSQAb.js","assets/ProductFormScreenStyled-Bu11-Uop.js","assets/DeliveryRegistrationScreen-BhZa1tcA.js","assets/MiComercioScreen-BqwIJ3tO.js","assets/ChatPedidoDialog-Bbob2QHc.js","assets/message-square-gYUmsK4G.js","assets/CommercePanelScreen-BzNmMx-b.js","assets/MetricTile-Al02hMcG.js","assets/ProductFormScreen-CgUSzV-8.js","assets/PanelRepartidorScreen-B-8DN9kH.js","assets/refresh-cw-BpmLW0Nf.js","assets/DeliveryPanelScreen-Cv-eHlo0.js","assets/AdminPostulacionesScreen-ggadzP7I.js","assets/AdminPanelScreen-D2G20E97.js"])))=>i.map(i=>d[i]);
import{r as m,a as go,g as fo,R as Ie,L as be,N as nr,u as yo,b as bo,c as Vt,H as xo,d as wo,e as W}from"./react-D_B_6qYb.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();var xa={exports:{}},ht={};/**
 * @license React
...
`,md=o.div`
  ...
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: ${({theme:e})=>e.spacing[2]};
`,hd=8;function gd(){const[e,r]=m.useState(""),{sortMode:a}=ed(),i=e.trim(),n=i.length>0,s=m.useMemo(()=>{const p=zl.filter(y=>Gt(i,y.name));return n?p:p.slice(0,hd)},[n,i]),c=m.useMemo(()=>ga(Pl.filter(p=>Gt(i,p.name,p.category,p.address)),a),[i,a]),u=m.useMemo(()=>ga(Ml.filter(p=>Gt(i,p.product,p.store)),a),[i,a]),h=s.length>0||c.length>0||u.length>0;return t.jsxs(zc,{query:e,onQueryChange:r,children:[t.jsx(ud,{children:t.jsx(Ce,{children:t.jsx(to,{value:e,onChange:r})})}),t.jsx(Ae,{children:t.jsx(Ce,{children:t.jsxs(td,{to:"/mandado",children:[t.jsx(rd,{children:t.jsx(Ye,{size:22,"aria-hidden":"true"})}),t.jsxs(ad,{children:[t.jsx(od,{children:"¿Necesitás algún mandado?"}),t.jsx(id,{children:"Pedí lo que sea y un repartidor lo busca."})]}),t.jsx(nd,{children:t.jsx(Fe,{size:18,"aria-hidden":"true"})})]})})}),n&&!h?t.jsx(Ae,{children:t.jsx(Ce,{children:t.jsx(Gc,{icon:Ui,title:"Sin resultados",text:`No encontramos nada para "${i}". Probá con otra palabra.`,dashed:!0})})}):null,s.length>0?t.jsx(Ae,{children:t.jsxs(Ce,{children:[t.jsx(qt,{title:"Categorías",subtitle:"Elegí un rubro y encontrá tu comercio.",seeAllTo:"/categorias"}),t.jsx(Yt,{as:dd,"aria-label":"Categorías",children:s.map((p,y)=>t.jsx(Nc,{id:p.id,name:p.name,to:`/comercios?rubro=${p.id}`,priority:y<5},p.id))})]})}):null,u.length>0?t.jsx(Ae,{children:t.jsxs(Ce,{children:[t.jsx(qt,{title:"Destacados",chip:"Ofertas",subtitle:"Los productos más pedidos cerca tuyo.",seeAllTo:"/comercios"}),t.jsx(Yt,{as:zr,"aria-label":"Productos destacados",children:u.map((p,y)=>t.jsx(tl,{name:p.product,store:p.store,price:p.price,oldPrice:p.oldPrice,categoryId:p.categoryId,imageLabel:p.imageLabel,tag:p.discount>0?`-${p.discount}%`:void 0,to:p.href,priority:y<3},p.id))})]})}):null,c.length>0?t.jsx(Ae,{children:t.jsxs(Ce,{children:[t.jsx(qt,{title:"Negocios",chip:"Locales",subtitle:"Los locales más elegidos de La Francia.",seeAllTo:"/comercios"}),t.jsx(Yt,{as:ld,"aria-label":"Negocios destacados",children:c.map((p,y)=>t.jsx(El,{id:p.id,name:p.name,category:p.category,categoryId:p.categoryId,to:p.href,distanceKm:p.distanceKm,rating:p.rating,openNow:p.openNow,premium:p.premium,etaMin:p.etaMin,etaMax:p.etaMax,priority:y<2},p.id))})]})}):null,n?null:t.jsx(Ae,{children:t.jsx(Ce,{children:t.jsx(po,{children:t.jsxs(pd,{children:[t.jsx(cl,{to:"/registro/comercio",title:"¿Querés sumar tu comercio?",text:"Registrá tu negocio y empezá a recibir pedidos.",icon:Me,tone:"brand"}),t.jsxs(md,{children:[t.jsx(pa,{to:"/trabaja-con-nosotros",label:"Sumate como Repartidor (Delivery)",icon:Qa}),t.jsx(pa,{to:"/registro/fletero",label:"Sumate como Fletero",icon:vr})]})]})})})})]})}const uo="https://lafranciago-api.lafranciago-api.workers.dev",Pr=()=>uo.length>0;class mo extends Error{constructor(r,a){super(r),this.status=a,this.name="ApiError"}}async function nt(e,r={}){const a=await fetch(`${uo}${e}`,{...r,credentials:"include",headers:{...r.body instanceof FormData?{}:{"Content-Type":"application/json"},...r.headers}});if(!a.ok){const i=await a.json().then(n=>n.error).catch(()=>null);throw new mo(i??`Error ${a.status}`,a.status)}return a.json()}const ee={get:e=>nt(e),post:(e,r)=>nt(e,{method:"POST",body:r instanceof FormData?r:JSON.stringify(r??{})}),patch:(e,r)=>nt(e,{method:"PATCH",body:JSON.stringify(r??{})}),delete:e=>nt(e,{method:"DELETE"})},He={registro:e=>ee.post("/auth/registro",e),login:e=>ee.post("/auth/login",e),loginPanel:e=>ee.post("/auth/login-panel",e),logout:()=>ee.post("/auth/logout"),yo:()=>ee.get("/auth/yo")},vp={crear:(e,r)=>ee.post("/postulaciones",{rol:e,datos:r}),mias:()=>ee.get("/postulaciones/mias")},kp={postulaciones:(e="pendiente")=>ee.get(`/admin/postulaciones?estado=${e}`),revisar:(e,r,a)=>ee.post(`/admin/postulaciones/${e}`,{decision:r,nota:a})},Sp={ver:()=>ee.get("/mi-comercio"),crearProducto:e=>ee.post("/productos",e),editarProducto:(e,r)=>ee.patch(`/productos/${e}`,r),borrarProducto:e=>ee.delete(`/productos/${e}`)},jp={pedidos:e=>ee.get(`/mi-comercio/pedidos${e?`?estado=${e}`:""}`),envios:()=>ee.get("/mi-comercio/envios"),mensajes:e=>ee.get(`/pedidos/${e}/mensajes`),enviarMensaje:(e,r)=>ee.post(`/pedidos/${e}/mensajes`,{texto:r})},Cp={disponibles:(e,r)=>{const a=new URLSearchParams;typeof e=="number"&&typeof r=="number"&&(a.set("lat",String(e)),a.set("lon",String(r)));const i=a.toString();return ee.get(`/delivery/disponibles${i?`?${i}`:""}`)},detalle:e=>ee.get(`/delivery/pedidos/${e}`),tomar:(e,r,a)=>ee.post(`/delivery/pedidos/${e}/tomar`,{lat:r,lon:a}),actualizarUbicacion:(e,r)=>ee.post("/delivery/ubicacion",{lat:e,lon:r})},Ap={subir:(e,r)=>{const a=new FormData;return a.append("archivo",e,r),ee.post("/media",a)}},rr=new Set;let ar=null,or=Pr()?"cargando":"invitado",ya=!1;const fd=()=>rr.forEach(e=>e()),Le=e=>{ar=e,or=e?"conectado":"invitado",fd()};async function ir(){if(Pr())try{Le(await He.yo())}catch(e){(!(e instanceof mo)||e.status!==401)&&console.warn("No se pudo recuperar la sesión",e),Le(null)}}function yd(){const[e,r]=m.useState({usuario:ar,estado:or});m.useEffect(()=>{const c=()=>r({usuario:ar,estado:or});return rr.add(c),ya||(ya=!0,ir()),c(),()=>{rr.delete(c)}},[]);const a=m.useCallback(async(c,u)=>{Le(await He.login({email:c,password:u}))},[]),i=m.useCallback(async c=>{Le(await He.registro(c))},[]),n=m.useCallback(async(c,u,h)=>{Le(await He.loginPanel({email:c,password:u,rol:h}))},[]),s=m.useCallback(async()=>{try{await He.logout()}finally{Le(null)}},[]);return{usuario:e.usuario,estado:e.estado,conectado:e.estado==="conectado",entrar:a,entrarAlPanel:n,registrar:i,salir:s,refrescar:ir}}function Ep(){return new Promise((e,r)=>{const a="https://lafranciago-api.lafranciago-api.workers.dev",s=window.screenX+(window.outerWidth-480)/2,c=window.screenY+(window.outerHeight-640)/2,u=window.open(`${a}/auth/google`,"lafranciago-google",`width=480,height=640,left=${s},top=${c}`);if(!u){r(new Error("Permití las ventanas emergentes para entrar con Google."));return}let h=!1;const p=()=>{window.removeEventListener("message",y),window.clearInterval(g)};function y(C){if(C.origin!==new URL(a).origin)return;const A=C.data;(A==null?void 0:A.tipo)==="lafranciago:oauth"&&(h=!0,p(),A.exito?ir().then(()=>e()):r(new Error(A.mensaje??"No pudimos completar el ingreso.")))}window.addEventListener("message",y);const g=window.setInterval(()=>{u.closed&&!h&&(p(),r(new Error("Cerraste la ventana antes de terminar.")))},600)})}function le({children:e}){const{estado:r}=yd(),a=bo();if(!Pr())return t.jsx(t.Fragment,{children:e});if(r==="cargando")return null;if(r==="invitado"){const i=`${a.pathname}${a.search}`;return t.jsx(Vt,{to:`/ingresar?destino=${encodeURIComponent(i)}`,replace:!0})}return t.jsx(t.Fragment,{children:e})}const bd=m.lazy(()=>J(()=>import("./AuthScreen-CDXarh1G.js"),__vite__mapDeps([5,1,6,7,8,9,10,11])).then(e=>({default:e.AuthScreen}))),xd=m.lazy(()=>J(()=>import("./CategoriesScreen-DuMtXs-f.js"),__vite__mapDeps([12,1])).then(e=>({default:e.CategoriesScreen}))),wd=m.lazy(()=>J(()=>import("./StoresDirectoryScreen-9HcA-_EJ.js"),__vite__mapDeps([13,1])).then(e=>({default:e.StoresDirectoryScreen}))),$d=m.lazy(()=>J(()=>import("./StoreProfileScreen-CUresjry.js"),__vite__mapDeps([14,1,15,16,17])).then(e=>({default:e.StoreProfileScreen}))),vd=m.lazy(()=>J(()=>import("./ProductDetailScreen-D8W5bHFf.js"),__vite__mapDeps([18,1,19])).then(e=>({default:e.ProductDetailScreen}))),kd=m.lazy(()=>J(()=>import("./MyOrdersScreen-BulgjUuW.js"),__vite__mapDeps([20,1,17,21])).then(e=>({default:e.MyOrdersScreen}))),Sd=m.lazy(()=>J(()=>import("./CartScreen-BrT-17tH.js"),__vite__mapDeps([22,1,15,21,23,16,10])).then(e=>({default:e.CartScreen}))),jd=m.lazy(()=>J(()=>import("./ErrandScreen-DK6BRTnr.js"),__vite__mapDeps([24,1,25,10])).then(e=>({default:e.ErrandScreen}))),Cd=m.lazy(()=>J(()=>import("./ErrandChatScreen-DIxSE3fk.js"),__vite__mapDeps([26,1,27,25,28,29])).then(e=>({default:e.ErrandChatScreen}))),Ad=m.lazy(()=>J(()=>import("./FavoritesScreen-B-t1RXOM.js"),__vite__mapDeps([30,1])).then(e=>({default:e.FavoritesScreen}))),Ed=m.lazy(()=>J(()=>import("./NotificationsScreen-BTTCDNkr.js"),__vite__mapDeps([31,1,32])).then(e=>({default:e.NotificationsScreen}))),zd=m.lazy(()=>J(()=>import("./CustomerAccountScreen-BCqINIS2.js"),__vite__mapDeps([33,1,19,27,28,34,10,11])).then(e=>({default:e.CustomerAccountScreen}))),Pd=m.lazy(()=>J(()=>import("./CommerceRegistrationScreen-WaKfnW8I.js"),__vite__mapDeps([35,1,27,36,37,38,6,34,10])).then(e=>({default:e.CommerceRegistrationScreen}))),ba=m.lazy(()=>J(()=>import("./DeliveryRegistrationScreen-BhZa1tcA.js"),__vite__mapDeps([39,37,1,27,6,10,34,9])).then(e=>({default:e.DeliveryRegistrationScreen}))),Md=m.lazy(()=>J(()=>import("./MiComercioScreen-BqwIJ3tO.js"),__vite__mapDeps([40,1,15,41,7,8,29,23,2,3,27,36,6,38,42])).then(e=>({default:e.MiComercioScreen}))),Id=m.lazy(()=>J(()=>import("./CommercePanelScreen-BzNmMx-b.js"),__vite__mapDeps([43,44,19,1,32])).then(e=>({default:e.CommercePanelScreen}))),Rd=m.lazy(()=>J(()=>import("./ProductFormScreen-CgUSzV-8.js"),__vite__mapDeps([45,1,15,27,38])).then(e=>({default:e.ProductFormScreen}))),Ld=m.lazy(()=>J(()=>import("./PanelRepartidorScreen-B-8DN9kH.js"),__vite__mapDeps([46,1,4,41,7,8,29,15,47])).then(e=>({default:e.PanelRepartidorScreen}))),_d=m.lazy(()=>J(()=>import("./DeliveryPanelScreen-Cv-eHlo0.js"),__vite__mapDeps([48,44,19,1])).then(e=>({default:e.DeliveryPanelScreen}))),Td=m.lazy(()=>J(()=>import("./AdminPostulacionesScreen-ggadzP7I.js"),__vite__mapDeps([49,1,7,47,42])).then(e=>({default:e.AdminPostulacionesScreen}))),Fd=m.lazy(()=>J(()=>import("./AdminPanelScreen-D2G20E97.js"),__vite__mapDeps([50,44,19,1])).then(e=>({default:e.AdminPanelScreen})));function Nd(){return t.jsx(xo,{children:t.jsx(_i,{children:t.jsx(m.Suspense,{fallback:null,children:t.jsxs(wo,{children:[t.jsx(W,{path:"/",element:t.jsx(gd,{})}),t.jsx(W,{path:"/ingresar",element:t.jsx(bd,{})}),t.jsx(W,{path:"/categorias",element:t.jsx(xd,{})}),t.jsx(W,{path:"/comercios",element:t.jsx(wd,{})}),t.jsx(W,{path:"/comercios/:storeId",element:t.jsx($d,{})}),t.jsx(W,{path:"/productos/:productId",element:t.jsx(vd,{})}),t.jsx(W,{path:"/pedidos",element:t.jsx(le,{children:t.jsx(kd,{})})}),t.jsx(W,{path:"/carrito",element:t.jsx(le,{children:t.jsx(Sd,{})})}),t.jsx(W,{path:"/mandado",element:t.jsx(le,{children:t.jsx(jd,{})})}),t.jsx(W,{path:"/mandado/chat",element:t.jsx(le,{children:t.jsx(Cd,{})})}),t.jsx(W,{path:"/favoritos",element:t.jsx(le,{children:t.jsx(Ad,{})})}),t.jsx(W,{path:"/notificaciones",element:t.jsx(le,{children:t.jsx(Ed,{})})}),t.jsx(W,{path:"/registro/comercio",element:t.jsx(le,{children:t.jsx(Pd,{})})}),t.jsx(W,{path:"/trabaja-con-nosotros",element:t.jsx(le,{children:t.jsx(ba,{})})}),t.jsx(W,{path:"/registro/fletero",element:t.jsx(le,{children:t.jsx(ba,{role:"fletero"})})}),t.jsx(W,{path:"/registro/delivery",element:t.jsx(Vt,{to:"/trabaja-con-nosotros",replace:!0})}),t.jsx(W,{path:"/mi-cuenta",element:t.jsx(le,{children:t.jsx(zd,{})})}),t.jsx(W,{path:"/panel/comercio",element:t.jsx(le,{children:t.jsx(Md,{})})}),t.jsx(W,{path:"/panel/comercio/metricas",element:t.jsx(le,{children:t.jsx(Id,{})})}),t.jsx(W,{path:"/panel/comercio/producto",element:t.jsx(le,{children:t.jsx(Rd,{})})}),t.jsx(W,{path:"/panel/repartidor",element:t.jsx(le,{children:t.jsx(Ld,{})})}),t.jsx(W,{path:"/panel/repartidor/metricas",element:t.jsx(le,{children:t.jsx(_d,{})})}),t.jsx(W,{path:"/panel/admin",element:t.jsx(le,{children:t.jsx(Fd,{})})}),t.jsx(W,{path:"/panel/admin/postulaciones",element:t.jsx(le,{children:t.jsx(Td,{})})}),t.jsx(W,{path:"*",element:t.jsx(Vt,{to:"/",replace:!0})})]})})})})}const Od=()=>{try{window.top!==window.self&&(window.top.location=window.self.location)}catch{document.documentElement.style.display="none"}};Od();zo({immediate:!0});const ho=document.getElementById("root");if(!ho)throw new Error("No se encontró el nodo root");Kt.createRoot(ho).render(t.jsx(Ie.StrictMode,{children:t.jsx(Nd,{})}));export{Gd as $,Er as A,io as B,Xd as C,da as D,Gc as E,Vd as F,Va as G,Bi as H,Qi as I,Pc as J,Rc as K,Lc as L,zc as M,Yc as N,mt as O,yp as P,ae as Q,mp as R,Ce as S,op as T,kr as U,Ae as V,Ye as W,Ja as X,Bd as Y,Hd as Z,qd as _,Zd as a,Jt as a0,Yd as a1,po as a2,zr as a3,Ji as a4,gp as a5,_l as a6,Il as a7,Rl as a8,hp as a9,zs as aA,Qd as aB,Ap as aC,vp as aD,mo as aE,sd as aF,er as aG,Sp as aH,jp as aI,bp as aJ,np as aK,sp as aL,cp as aM,en as aN,Xi as aO,Cp as aP,lp as aQ,dp as aR,Wi as aS,kp as aT,pp as aU,up as aV,Me as aa,Is as ab,Ms as ac,Fe as ad,$p as ae,ap as af,je as ag,Sn as ah,Wd as ai,vr as aj,Kd as ak,Jd as al,pn as am,es as an,Di as ao,_t as ap,xr as aq,ip as ar,ut as as,an as at,ep as au,Qa as av,wp as aw,Ud as ax,Ga as ay,cd as az,xp as b,z as c,As as d,Es as e,rp as f,ud as g,Pr as h,Ep as i,t as j,to as k,qt as l,Gt as m,Nc as n,Ui as o,ed as p,o as q,ga as r,so as s,Yt as t,yd as u,tp as v,fp as w,El as x,Cr as y,Ar as z};
