import{a6 as G,i as o,j as a,M as ae,D as re,a as oe,d as ie,ad as B,t as te,C as se}from"./index-Cc6rlhUm.js";import{r as n}from"./react-Clk3ySf9.js";import{M as d,I as ne,f as C,V as de,v as ce,p as le,a as me}from"./mediaService-Be9g9s7c.js";/**
...
`,Se=o.p`
  ...
  font-size: ${({theme:e})=>e.typography.size.sm};
  font-weight: ${({theme:e})=>e.typography.weight.bold};
`,we="almacen";function Pe(){const e=n.useMemo(()=>he(we),[]),x=(e==null?void 0:e.suggestedCategories)??[],[S,w]=n.useState(""),[$,k]=n.useState(""),[z,F]=n.useState(""),[_,P]=n.useState(""),[c,j]=n.useState([]),[t,v]=n.useState(null),[M,u]=n.useState(null),[p,R]=n.useState(!1),[Q,I]=n.useState(!1),[L,E]=n.useState(!1);n.useEffect(()=>()=>{c.forEach(r=>URL.revokeObjectURL(r.previewUrl)),t&&URL.revokeObjectURL(t.url)},[c,t]);const Y=async r=>{if(!(r!=null&&r.length))return;u(null);const i=d.maxImages-c.length;if(i<=0){u(`Podés subir hasta ${d.maxImages} fotos.`);return}E(!0);const l=Array.from(r).slice(0,i),m=[];for(const h of l){const V=ce(h);if(V){u(V);continue}try{const ee=await le(h);m.push({...ee,id:`${h.name}-${Date.now()}-${m.length}`})}catch{u("No pudimos procesar una de las fotos.")}}j(h=>[...h,...m]),E(!1)},J=async r=>{const i=r==null?void 0:r[0];if(!i)return;u(null);const l=await me(i);if(l){u(l);return}v({url:URL.createObjectURL(i),bytes:i.size,name:i.name})},K=r=>{j(i=>{const l=i.find(m=>m.id===r);return l&&URL.revokeObjectURL(l.previewUrl),i.filter(m=>m.id!==r)})},X=()=>{t&&URL.revokeObjectURL(t.url),v(null)},s={name:S.trim().length<2?"Poné el nombre del producto.":null,price:!$||Number($)<=0?"Poné un precio válido.":null,category:z?null:"Elegí una categoría."},Z=!s.name&&!s.price&&!s.category,W=r=>{r.preventDefault(),R(!0),Z&&(I(!0),window.setTimeout(()=>I(!1),2600),c.forEach(i=>URL.revokeObjectURL(i.previewUrl)),t&&URL.revokeObjectURL(t.url),w(""),k(""),F(""),P(""),j([]),v(null),R(!1))},U=c.reduce((r,i)=>r+i.bytes,0)+((t==null?void 0:t.bytes)??0);return a.jsxs(ae,{showSearch:!1,children:[a.jsx(re,{children:a.jsxs(oe,{children:[a.jsx(ie,{title:"Nuevo producto",chip:e==null?void 0:e.name,subtitle:"Todo producto entra en una categoría de tu comercio."}),a.jsxs(be,{as:"form",onSubmit:W,noValidate:!0,children:[a.jsxs(ye,{children:[a.jsxs(b,{children:[a.jsx(g,{htmlFor:"product-name",children:"Nombre"}),a.jsx(A,{id:"product-name",value:S,onChange:r=>w(r.target.value),placeholder:"Ej: Coca Cola 2,25 L","data-invalid":p&&!!s.name}),p&&s.name?a.jsx(f,{children:s.name}):null]}),a.jsxs(b,{children:[a.jsx(g,{htmlFor:"product-price",children:"Precio"}),a.jsx(A,{id:"product-price",type:"number",inputMode:"decimal",min:"0",value:$,onChange:r=>k(r.target.value),placeholder:"0","data-invalid":p&&!!s.price}),p&&s.price?a.jsx(f,{children:s.price}):null]}),a.jsxs(b,{children:[a.jsx(g,{htmlFor:"product-category",children:"Categoría"}),a.jsxs(fe,{id:"product-category",value:z,onChange:r=>F(r.target.value),"data-invalid":p&&!!s.category,children:[a.jsx("option",{value:"",children:"Elegí una categoría"}),x.map(r=>a.jsx("option",{value:r.id,children:r.name},r.id))]}),p&&s.category?a.jsx(f,{children:s.category}):a.jsxs(y,{children:["Sugeridas para ",e==null?void 0:e.name,"."]})]}),a.jsxs(b,{children:[a.jsx(g,{htmlFor:"product-description",children:"Descripción"}),a.jsx(xe,{id:"product-description",value:_,onChange:r=>P(r.target.value),placeholder:"Opcional: detalle breve del producto.",rows:3})]})]}),a.jsxs(H,{children:[a.jsx(g,{as:"span",children:"Fotos"}),a.jsxs(O,{children:[c.length,"/",d.maxImages]})]}),a.jsxs($e,{children:[c.map(r=>a.jsxs(D,{children:[a.jsx(je,{src:r.previewUrl,alt:""}),a.jsx(N,{type:"button",onClick:()=>K(r.id),"aria-label":"Quitar foto",children:a.jsx(B,{size:14,"aria-hidden":"true"})})]},r.id)),c.length<d.maxImages?a.jsxs(T,{as:"label","data-busy":L,children:[a.jsx(ue,{size:20,"aria-hidden":"true"}),a.jsx("span",{children:L?"Optimizando…":"Agregar"}),a.jsx("input",{type:"file",accept:ne,multiple:!0,hidden:!0,onChange:r=>{Y(r.target.files),r.target.value=""}})]}):null]}),a.jsxs(y,{children:["Se redimensionan a ",d.maxImageDimension,"px y se comprimen solas: cada foto queda en menos de ",C(d.maxImageBytes),"."]}),a.jsxs(H,{children:[a.jsx(g,{as:"span",children:"Video"}),a.jsxs(O,{children:[t?1:0,"/",d.maxVideos]})]}),t?a.jsxs(D,{"data-video":"true",children:[a.jsx(ve,{src:t.url,controls:!0,preload:"metadata"}),a.jsx(N,{type:"button",onClick:X,"aria-label":"Quitar video",children:a.jsx(B,{size:14,"aria-hidden":"true"})})]}):a.jsxs(T,{as:"label","data-wide":"true",children:[a.jsx(pe,{size:20,"aria-hidden":"true"}),a.jsx("span",{children:"Agregar video"}),a.jsx("input",{type:"file",accept:de,hidden:!0,onChange:r=>{J(r.target.files),r.target.value=""}})]}),a.jsxs(y,{children:["Hasta ",d.maxVideoSeconds," segundos y"," ",C(d.maxVideoBytes),"."]}),M?a.jsx(f,{children:M}):null,U>0?a.jsxs(y,{children:["Total a subir: ",C(U),"."]}):null,a.jsx(Ce,{type:"submit",children:"Guardar producto"}),Q?a.jsxs(Se,{role:"status",children:[a.jsx(te,{size:16,"aria-hidden":"true"}),"Producto guardado en tu catálogo."]}):null]})]})}),a.jsx(se,{"aria-hidden":"true"})]})}export{Pe as ProductFormScreen};
