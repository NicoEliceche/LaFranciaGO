import{ab as E,ac as x,q as a,ad as j,ae as Z,j as r,O as ce,a as w,b as ee,af as T,K as pe,M as q,S as k,E as ge,a0 as B,ag as he,ah as f,w as ue,d as me,y as h,X as ye,z as N,ai as y,aj as be,c as S,ak as U,a7 as xe,a8 as fe,al as $e}from"./index-zg-QSFtH.js";import{r as u,u as je}from"./react-B1kPYQQd.js";import{m as re,a as we,s as Ce}from"./saleUnits-CLP-TCsg.js";import{p as ve}from"./ordersStore-B3gJ5R2s.js";import{M as ke}from"./minus-CWDFqidu.js";import{S as Se}from"./shield-check-BaNpTk-9.js";/**
...
`;function Ge({open:e,title:i,text:t,confirmLabel:s="Aceptar",cancelLabel:d="Cancelar",onConfirm:p,onCancel:l}){return u.useEffect(()=>{if(!e)return;const g=C=>{C.key==="Escape"&&l()};return document.addEventListener("keydown",g),()=>document.removeEventListener("keydown",g)},[l,e]),e?r.jsx(Re,{onClick:l,role:"presentation",children:r.jsxs(Oe,{role:"alertdialog","aria-modal":"true","aria-label":i,onClick:g=>g.stopPropagation(),children:[r.jsx(qe,{children:i}),t?r.jsx(Be,{children:t}):null,r.jsxs(Ne,{children:[r.jsx(Ue,{type:"button",onClick:l,children:d}),r.jsx(De,{type:"button",onClick:p,autoFocus:!0,children:s})]})]})}):null}const Qe=a.div`
  display: grid;
  gap: ${({theme:e})=>e.spacing[2]};
`,Ye=a(w)`
  position: relative;
