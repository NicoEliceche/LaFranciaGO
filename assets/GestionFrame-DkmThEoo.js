import{j as e,bf as A}from"./index-PN1N2eMW.js";import{r as n,u as q,c as I}from"./react-6hK8W6IX.js";import{q as i}from"./estilos-DzHAJWDP.js";import{aE as v,X as S,k as L,i as T,aq as F,a6 as O,av as D,as as R,r as B,a7 as H,am as V,T as G,an as U,af as N,ao as _,aF as Q,s as W,aG as X,A as J,f as K,g as Y,aH as Z,aI as oo}from"./iconos-D4KLLVJ2.js";function eo(){return typeof window>"u"?"navegador":window.lafranciagoEscritorio?"escritorio":/Android|iPhone|iPad/i.test(navigator.userAgent)&&!window.matchMedia("(pointer: fine)").matches?"telefono":"navegador"}const C=()=>eo()==="escritorio",ao={cajaRapida:"mostrador",lectora:"mostrador",etiquetas:"mostrador"};function io(o){return ao[o]!=="mostrador"||C()}const Co="Esto funciona en la computadora del negocio, donde están la lectora y la impresora.",to=i.div`
  display: flex;
  align-items: center;
