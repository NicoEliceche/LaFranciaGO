import{c as L,Y as we,q as a,Z as Ce,d as E,e as se,aj as H,ak as A,V as ve,al as ke,j as r,M as Q,S,E as Se,a7 as G,am as ze,an as f,D as Ie,a as Me,H as m,X as Pe,I as U,ao as y,ap as Te,C as z,ae as Le,af as Ee,aq as He,ar as Ae,h as V,ah as qe}from"./index-BqcRuPDG.js";import{r as h,u as Re}from"./react-D_B_6qYb.js";import{s as Fe,m as Be}from"./saleUnits-CLP-TCsg.js";import{u as De,M as Oe,c as Ne,b as W,r as Qe}from"./cartStore-Bl4RJEoU.js";import{C as Ge}from"./ConfirmDialog-Bn7LYIKc.js";import{S as Ue}from"./shield-check-C6ntK1bb.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y=L("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]),Ye=new Set;let K=[...we],I=1249;const Ke=()=>Ye.forEach(e=>e()),Xe=()=>`Hoy ${new Date().toLocaleTimeString("es-AR",{hour:"2-digit",minute:"2-digit"})}`;function Ze(e){const l=e.filter(s=>s.available);if(l.length===0)return[];const i=new Map;l.forEach(s=>{const g=i.get(s.store)??[];g.push(s),i.set(s.store,g)});const n=[];return i.forEach((s,g)=>{I+=1,n.push({id:`ord-${I}`,code:`#${I}`,store:g,storeId:s[0].store.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""),categoryId:s[0].categoryId,total:s.reduce((c,u)=>c+u.subtotal,0),status:"En preparación",state:"proceso",eta:`Llega en ${s[0].eta}`,date:Xe(),itemCount:s.length,items:s.map(c=>({productId:c.id,quantity:c.quantity+1}))})}),K=[...n,...K],Ke(),n}const Je=a.div`
  display: grid;
