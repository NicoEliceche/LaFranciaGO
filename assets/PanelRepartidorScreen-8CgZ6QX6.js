import{j as a,af as pe,ag as he,ah as ge,c as me,ai as fe,e as I,r as b,ae as ke,E as A,p as F,q as xe,a as H,b as G,bi as w,d as ae,k as Ce,aC as Ee,n as Pe,M as De,C as Te,S as Me,N as qe}from"./index-BOa_sN7e.js";import{r as t}from"./react-6hK8W6IX.js";import{u as Ne}from"./useCurrentPosition-Dx7CHxa8.js";import{C as _e}from"./ChatPedidoDialog-BIf4oYRK.js";import{E as Le,a as oe}from"./ChatPedidoDialogStyled-MvteS_Yt.js";import{g as Re,M as Ve,q as _,r as L,s as R,t as V}from"./MiComercioScreenStyled-DB8QgGpz.js";import{a as Fe,R as Ae,b as Ie}from"./ResenaDialogStyled-JI9jT6su.js";import{X as ye,aM as K,T as Q,u as be,i as Oe,M as je,aN as Be,_ as Ue,aK as He,h as Ge,aO as Ke}from"./iconos-C-3VosUP.js";import{q as i}from"./estilos-DzHAJWDP.js";import{s as Qe}from"./saleUnits-CLP-TCsg.js";import"./MotivoDialog-BC6bPiSu.js";const te=900,re=2500;function Xe({open:e,pedidoId:n,distanciaKm:h,onCerrar:p,onCotizado:r}){const[l,f]=t.useState(""),[v,u]=t.useState(""),[s,x]=t.useState(!1),[z,c]=t.useState(null),g=typeof h=="number"?Math.round(re+h*te):null;if(t.useEffect(()=>{e&&(f(g!==null?String(g):""),u(""),c(null))},[e,g]),t.useEffect(()=>{if(!e)return;const j=S=>{S.key==="Escape"&&p()};return document.addEventListener("keydown",j),()=>document.removeEventListener("keydown",j)},[p,e]),!e)return null;const y=async j=>{j.preventDefault();const S=Number(l);if(!(!Number.isFinite(S)||S<=0||s)){x(!0),c(null);try{await ke.cotizar(n,S,v.trim()||void 0),r(),p()}catch(D){c(D instanceof Error?D.message:"No pudimos enviar tu precio.")}finally{x(!1)}}};return a.jsx(pe,{role:"dialog","aria-modal":"true","aria-label":"Cotizar el flete",children:a.jsxs(he,{children:[a.jsxs(ge,{children:[a.jsx(me,{children:"¿Cuánto cobrás?"}),a.jsx(fe,{type:"button",onClick:p,"aria-label":"Cerrar",children:a.jsx(ye,{size:18,"aria-hidden":"true"})})]}),z?a.jsx(I,{role:"alert","data-tono":"error",children:z}):null,a.jsxs("form",{onSubmit:y,children:[a.jsxs(Re,{children:[a.jsx("span",{children:"Tu precio"}),a.jsx("input",{type:"number",min:1,step:"1",value:l,autoFocus:!0,required:!0,onChange:j=>f(j.target.value)})]}),a.jsx(Fe,{children:typeof h=="number"?`Son ${h} km. A ${b(te)} el kilómetro más ${b(re)} de base daría ${b(g??0)}, pero ponés lo que quieras.`:"No pudimos calcular la distancia. Fijate el detalle antes de poner precio."}),a.jsxs(Ae,{children:[a.jsx("span",{children:"¿Querés aclarar algo?"}),a.jsx(Ie,{value:v,maxLength:300,placeholder:"Lo llevo hoy a la tarde. Necesito una mano para cargar.",onChange:j=>u(j.target.value)})]}),a.jsxs(Le,{children:[a.jsx(oe,{type:"button","data-tono":"suave",onClick:p,disabled:s,children:"Volver"}),a.jsx(oe,{type:"submit",disabled:s||l.trim()==="",children:s?"Enviando…":"Enviar mi precio"})]})]})]})})}const Ze=i.div`
  display: grid;
