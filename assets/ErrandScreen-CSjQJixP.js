import{q as o,ai as m,j as e,M as y,T as x,S as f,k as $,ap as b,V as j,N as S}from"./index-DlPjbtwt.js";import{u as E,r as c}from"./react-D_B_6qYb.js";import{D as z,c as w}from"./errandStore-Bion9qKH.js";import{S as v}from"./shield-check-C7JJ9OcF.js";const k=o.div`
  display: grid;
...
`,A=10,p="Av. San Martín 123";function _(){const r=E(),[s,h]=c.useState(""),[d,u]=c.useState(!1),l=s.trim(),a=l.length<A?"Contanos un poco más de lo que necesitás.":null,g=i=>{i.preventDefault(),u(!0),!a&&(w(l,p),r("/mandado/chat"))};return e.jsx(y,{showSearch:!1,children:e.jsx(x,{children:e.jsxs(f,{children:[e.jsx($,{title:"¿Qué necesitás?",chip:"Mandado",subtitle:"Contanos qué hay que comprar o retirar."}),e.jsxs(k,{as:"form",onSubmit:g,noValidate:!0,children:[e.jsx(D,{htmlFor:"errand-description",children:"Descripción del mandado"}),e.jsx(M,{id:"errand-description",value:s,onChange:i=>h(i.target.value),placeholder:"Ej: Necesito 2 bolsas de hielo, una Coca de 2,25 L y un alfajor de la despensa de la esquina.",rows:5,"data-invalid":d&&!!a,autoFocus:!0}),d&&a?e.jsx(C,{children:a}):e.jsx(q,{children:"Cuanto más claro lo escribas, menos preguntas te va a hacer el repartidor."}),e.jsx(F,{children:"Después vas a poder mandarle fotos y audios por el chat para coordinar."}),e.jsxs(N,{children:[e.jsxs(t,{children:[e.jsx(n,{children:e.jsx(b,{size:16,"aria-hidden":"true"})}),"Lo ven los repartidores en ",z," km a la redonda."]}),e.jsxs(t,{children:[e.jsx(n,{children:e.jsx(j,{size:16,"aria-hidden":"true"})}),"El primero que lo toma se queda con el pedido."]}),e.jsxs(t,{children:[e.jsx(n,{children:e.jsx(S,{size:16,"aria-hidden":"true"})}),"Entrega en ",p,"."]}),e.jsxs(t,{children:[e.jsx(n,{children:e.jsx(v,{size:16,"aria-hidden":"true"})}),"Pagás al recibir, cuando ya sabés el total."]})]}),e.jsx(I,{type:"submit",children:"Generar pedido de mandado"})]})]})})})}export{_ as ErrandScreen};
