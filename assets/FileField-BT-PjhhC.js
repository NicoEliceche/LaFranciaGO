import{c as s,q as o,a7 as n,az as $,aI as w,j as r,p as k,X as F}from"./index-99PGXNK_.js";import{r as l}from"./react-D_B_6qYb.js";import{f as v}from"./mediaService-D2_VAu2k.js";/**
...
`;function N({id:e,accept:m,required:h,label:f="Elegir archivo",onChange:a}){const x=l.useId(),d=e??x,i=l.useRef(null),[t,c]=l.useState(null),b=y=>{var u;const p=((u=y.target.files)==null?void 0:u[0])??null;c(p),a==null||a(p)},g=()=>{i.current&&(i.current.value=""),c(null),a==null||a(null)};return r.jsxs(H,{children:[r.jsxs(I,{"data-filled":!!t,children:[r.jsxs(M,{htmlFor:d,children:[r.jsx(z,{size:16,"aria-hidden":"true"}),f]}),r.jsxs(q,{"data-filled":!!t,children:[r.jsx(E,{"data-filled":!!t,"aria-hidden":"true",children:t?r.jsx(k,{size:13}):r.jsx(j,{size:13})}),r.jsx(X,{title:t==null?void 0:t.name,children:t?`${t.name} · ${v(t.size)}`:"Sin archivo"})]}),t?r.jsx(B,{type:"button",onClick:g,"aria-label":"Quitar el archivo",children:r.jsx(F,{size:14,"aria-hidden":"true"})}):null]}),r.jsx("input",{ref:i,id:d,type:"file",accept:m,required:h,onChange:b,hidden:!0})]})}export{A as F,z as U,N as a};
