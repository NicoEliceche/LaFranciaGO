import{q as r,j as a,G as K,H as W,I as X,J as Z,K as L,L as te,N as se,O as ne,Q as de,R as le,T as ce,V as pe,W as ge,h as me,Y as ue,Z as be,k as he,_ as fe,$ as ye,M as xe,a0 as B,S as F,a1 as $e,a2 as we,a3 as je,a4 as ke,a5 as ve,a6 as Ce,a7 as ze,x as U,a8 as Se,p as N,E as Pe,s as Le,a9 as Ie,aa as Me,d as I,a as qe}from"./index-Bc4FkQ3o.js";import{r as l,L as Be,h as Fe,f as Ae}from"./react-D_B_6qYb.js";import{p as Ee,s as D,m as R}from"./saleUnits-CLP-TCsg.js";import{M as He,a as Te}from"./cartStore-BrnRW5uM.js";import{C as Oe}from"./clock-3-ClxBJ32x.js";const Ue=r.article`
  display: flex;
...
`,Ke=r.span`
  ...
  font-size: ${({theme:e})=>e.typography.size.xs};
  font-weight: ${({theme:e})=>e.typography.weight.semibold};
`,C=1;function V({name:e,price:s,saleUnit:p,categoryId:h,badge:n,quantity:b,onAdd:f,priority:y}){const[c,m]=l.useState(C),[j,g]=l.useState(!1),$=()=>{f(c),m(C),g(!0),window.setTimeout(()=>g(!1),1400)};return a.jsxs(Ue,{"data-active":b>0,children:[a.jsxs(K,{$ratio:"1 / 1",children:[a.jsx(W,{src:X(h),alt:e,loading:y?"eager":"lazy"}),n?a.jsx(Z,{children:a.jsx(Ve,{children:n})}):null]}),a.jsxs(Ne,{children:[a.jsx(De,{children:e}),a.jsxs(Re,{children:[a.jsxs(Qe,{children:[L(s),p&&p!=="unidad"?a.jsxs(Ke,{children:[" ",Ee(p)]}):null]}),a.jsxs(Ye,{children:[a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.max(C,w-1)),disabled:c<=C,"aria-label":`Quitar cantidad de ${e}`,children:a.jsx(He,{size:16,"aria-hidden":"true"})}),a.jsx(_e,{"aria-live":"polite",children:D(p,c-C)}),a.jsx(Q,{type:"button",onClick:()=>m(w=>Math.min(w+1,R(p)+C)),disabled:c-C>=R(p),"aria-label":`Agregar cantidad de ${e}`,children:a.jsx(te,{size:16,"aria-hidden":"true"})})]})]}),a.jsx(Ge,{type:"button",onClick:$,"data-added":j,children:j?a.jsxs(a.Fragment,{children:[a.jsx(se,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),b>0?a.jsxs(Je,{children:[D(p,b-C)," en el pedido"]}):null]})]})}const We=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
