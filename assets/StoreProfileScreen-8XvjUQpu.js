import{j as o,Q as re,R as ie,T as te,U as se,r as q,V as ue,W as be,X as he,Y as fe,h as ye,Z as xe,u as $e,_ as we,$ as je,M as ve,a0 as A,S as E,a1 as ke,a2 as Ce,a3 as Se,a4 as ze,a5 as Pe,G as Y,p as Le,q as G,E as Ie,a6 as qe,a as M,d as Me}from"./index-cXqEpeJy.js";import{r as l,L as Be,h as Fe,d as Ae}from"./react-6hK8W6IX.js";import{q as r,A as Ee}from"./estilos-DzHAJWDP.js";import{p as Oe,m as W,s as X}from"./saleUnits-CLP-TCsg.js";import{P as He,a2 as Te,C as Re,t as Ue,a3 as Ne,M as De,h as Qe,S as Ve,O as _e,m as Ye}from"./iconos-DPkufriG.js";import{u as Ge,a as We}from"./cartStore-0fSA2Xh5.js";const Xe=r.article`
  display: flex;
...
`,k=1;function K({name:e,price:n,saleUnit:c,categoryId:x,badge:d,quantity:h,onAdd:j,priority:f}){const[b,p]=l.useState(k),[m,v]=l.useState(!1),u=()=>{j(b),p(k),v(!0),window.setTimeout(()=>v(!1),1400)};return o.jsxs(Xe,{"data-active":h>0,children:[o.jsxs(re,{$ratio:"1 / 1",children:[o.jsx(ie,{src:te(x),alt:e,loading:f?"eager":"lazy"}),d?o.jsx(se,{children:o.jsx(oa,{children:d})}):null]}),o.jsxs(Je,{children:[o.jsx(Ke,{children:e}),o.jsxs(Ze,{children:[o.jsxs(ea,{children:[o.jsx(aa,{children:q(n)}),c&&c!=="unidad"?o.jsx(na,{children:Oe(c)}):null]}),o.jsxs(ra,{children:[o.jsx(J,{type:"button",onClick:()=>p(y=>Math.min(y+1,W(c)+k)),disabled:b-k>=W(c),"aria-label":`Agregar cantidad de ${e}`,children:o.jsx(He,{size:15,"aria-hidden":"true"})}),o.jsx(ia,{"aria-live":"polite",children:X(c,b-k)}),o.jsx(J,{type:"button",onClick:()=>p(y=>Math.max(k,y-1)),disabled:b<=k,"aria-label":`Quitar cantidad de ${e}`,children:o.jsx(Te,{size:15,"aria-hidden":"true"})})]})]}),o.jsx(ta,{type:"button",onClick:u,"data-added":m,children:m?o.jsxs(o.Fragment,{children:[o.jsx(Re,{size:15,"aria-hidden":"true"}),"Agregado"]}):"Agregar al carrito"}),h>0?o.jsxs(sa,{children:[X(c,h-k)," en el pedido"]}):null]})]})}const da=r.div`
  border-radius: ${({theme:e})=>e.radius.xl};
  border: 1px solid ${({theme:e})=>e.color.border};
  background: ${({theme:e})=>e.color.surface};
  box-shadow: ${({theme:e})=>e.shadow.sm};
...
`,ba=r.span`
  ...
  font-weight: ${({theme:e})=>e.typography.weight.bold};
  box-shadow: ${({theme:e})=>e.shadow.sm};
`;function ha({id:e,name:n,category:c,categoryId:x,address:d,hours:h,distanceKm:j,rating:f,openNow:b,minOrder:p}){return o.jsxs(da,{children:[o.jsxs(re,{$ratio:"21 / 9",children:[o.jsx(ie,{src:te(x),alt:c,loading:"eager"}),o.jsxs(se,{children:[o.jsx(ua,{"data-open":b,children:b?"Abierto ahora":"Cerrado"}),f!==void 0?o.jsxs(ba,{children:[o.jsx(Ue,{size:13,"aria-hidden":"true",fill:"currentColor"}),f.toFixed(1)]}):null]}),o.jsx(la,{children:o.jsx(ue,{$size:"3.5rem",$tone:he(e),children:be(n)})})]}),o.jsxs(ca,{children:[o.jsx(pa,{children:n}),o.jsxs(ga,{children:[c,j!==void 0?` · ${fe(j)}`:""]}),o.jsxs(ma,{children:[o.jsxs(O,{children:[o.jsx(Ne,{size:14,"aria-hidden":"true"}),h]}),o.jsxs(O,{children:[o.jsx(De,{size:14,"aria-hidden":"true"}),d]}),o.jsxs(O,{children:["Mínimo ",q(p)]})]})]})]})}const Z=["blue","green","orange","violet","red","slate"],ne="ofertas";function ee(e,n){if(e.tipo==="descuento")return{id:e.id,tipo:"descuento",titulo:e.titulo,porcentaje:e.porcentaje,precioFinal:Math.round(n*(100-(e.porcentaje??0)))/100,cantidad:null,etiqueta:`${e.porcentaje}% off`};if(e.tipo==="cantidad")return{id:e.id,tipo:"cantidad",titulo:e.titulo,porcentaje:null,precioFinal:null,cantidad:e.cantidad,etiqueta:`${e.cantidad} x $${e.precioFinal.toLocaleString("es-AR")}`};const c=e.productos.length-1;return{id:e.id,tipo:"combo",titulo:e.titulo,porcentaje:null,precioFinal:null,cantidad:null,etiqueta:c>0?`Combo con ${c} más`:"En combo"}}function fa(e){const[n,c]=l.useState(null),[x,d]=l.useState(!0);return l.useEffect(()=>{if(!e||!ye()){d(!1);return}let h=!0;return d(!0),xe.detalle(e).then(({comercio:j,categorias:f,productos:b,ofertas:p})=>{if(!h)return;const m=new Map;for(const t of p??[])for(const g of t.productos)m.has(g.id)||m.set(g.id,t);const v=(t,g,$)=>{var C;const w=m.get(t.id)??null;return{id:t.id,name:t.nombre,description:t.descripcion??"",categoryId:t.categoria_id??"general",categoryLabel:g,price:t.precio,saleUnit:t.unidad_venta,tone:Z[$%Z.length],badge:w?ee(w,t.precio).etiqueta:void 0,suggestions:[],foto:((C=t.fotos)==null?void 0:C[0])??null,stock:t.stock,tamano:t.tamano,oferta:w?ee(w,t.precio):null}},u=f.map(t=>({id:t.id,label:t.nombre,description:"",products:b.filter(g=>g.categoria_id===t.id).map((g,$)=>v(g,t.nombre,$))})).filter(t=>t.products.length>0),y=b.filter(t=>m.has(t.id)).map((t,g)=>{var $;return v(t,(($=f.find(w=>w.id===t.categoria_id))==null?void 0:$.nombre)??"Otros",g)});y.length>0&&u.unshift({id:ne,label:"Ofertas",description:"Lo que está en promoción ahora.",products:y});const z=b.filter(t=>!t.categoria_id||!f.some(g=>g.id===t.categoria_id));z.length>0&&u.push({id:"otros",label:"Otros productos",description:"",products:z.map((t,g)=>v(t,"Otros",g))}),c({intro:j.descripcion??"",secciones:u,ofertas:p??[],error:!1})}).catch(()=>{h&&c({intro:"",secciones:[],ofertas:[],error:!0})}).finally(()=>{h&&d(!1)}),()=>{h=!1}},[e]),{intro:(n==null?void 0:n.intro)??"",secciones:(n==null?void 0:n.secciones)??[],ofertas:(n==null?void 0:n.ofertas)??[],error:(n==null?void 0:n.error)??!1,cargando:x}}r.div`
  display: grid;
...
`;r(M)`
  border-style: dashed;
`;const Ma=e=>ae[e]??ae[La];function Ra(){var _;const{storeId:e=""}=Fe(),[n,c]=Ae(),{stores:x}=$e(),d=l.useMemo(()=>x.find(a=>a.id===e)??we(e)??x[0],[e,x]),{secciones:h,cargando:j}=fa(e),f=l.useMemo(()=>({intro:(d==null?void 0:d.summary)??"",sections:h.length>0?h:Ma(e).sections}),[h,d,e]),b=n.get("pedido"),p=l.useMemo(()=>b?je.find(a=>a.id===b&&a.storeId===d.id)??null:null,[b,d.id]),m=l.useMemo(()=>{if(!p)return f;const a=new Set(p.items.map(i=>i.productId));return{...f,sections:f.sections.map(i=>({...i,products:i.products.filter(s=>a.has(s.id))})).filter(i=>i.products.length>0)}},[f,p]),v=l.useMemo(()=>p?Object.fromEntries(p.items.map(a=>[a.productId,a.quantity])):{},[p]),u=l.useMemo(()=>m.sections.flatMap(a=>a.products),[m]),[y,z]=l.useState(""),[t,g]=l.useState("all"),[$,w]=l.useState(((_=u[0])==null?void 0:_.id)??""),[C,H]=l.useState({});l.useEffect(()=>{var i;const a=Object.fromEntries(u.map(s=>[s.id,0]));z(""),g("all"),w(((i=u[0])==null?void 0:i.id)??""),H(a)},[u,d.id]);const T=n.get("oferta"),R=l.useRef(null);l.useEffect(()=>{if(!T||j)return;const a=R.current;if(!a)return;const i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=window.requestAnimationFrame(()=>{a.scrollIntoView({behavior:i?"auto":"smooth",block:"start"})});return()=>window.cancelAnimationFrame(s)},[j,T,d.id]);const I=l.useMemo(()=>{const a=y.trim();return m.sections.filter(i=>t==="all"||i.id===t).map(i=>({...i,products:i.products.filter(s=>Ba(a,i,s))})).filter(i=>i.products.length>0)},[t,m,y]),S=l.useMemo(()=>I.flatMap(a=>a.products),[I]);l.useEffect(()=>{S.length!==0&&(S.some(a=>a.id===$)||w(S[0].id))},[$,S]);const B=l.useMemo(()=>S.find(a=>a.id===$)??S[0]??u[0],[u,$,S]),U=l.useMemo(()=>!B||p?[]:B.suggestions.map(a=>u.find(i=>i.id===a)).filter(a=>!!a).slice(0,4),[u,B]),N=Ge(),F=l.useMemo(()=>N.filter(a=>a.storeId===d.id),[N,d.id]),P=F.length,de=l.useMemo(()=>F.reduce((a,i)=>a+i.subtotal,0),[F]),D=l.useRef(null),[le,Q]=l.useState(0);l.useLayoutEffect(()=>{const a=D.current;if(!a){Q(0);return}const i=new ResizeObserver(()=>{const s=Number.parseFloat(getComputedStyle(a).bottom)||0;Q(a.offsetHeight+s)});return i.observe(a),()=>i.disconnect()},[P]),l.useMemo(()=>u.map(a=>({...a,quantity:C[a.id]??0})).filter(a=>a.quantity>0).sort((a,i)=>i.quantity-a.quantity).slice(0,3),[u,C]),l.useMemo(()=>{const a=y.trim().toLowerCase(),i=a?m.sections.filter(s=>s.label.toLowerCase().includes(a)||s.description.toLowerCase().includes(a)):m.sections;return i.length>0?i.slice(0,3):m.sections.slice(0,3)},[m.sections,y]);const ce=()=>{const a=new URLSearchParams(n);a.delete("pedido"),c(a,{replace:!0})},pe=a=>{a.preventDefault()},ge=(a,i)=>{H(s=>{const L=Math.max(0,(s[a]??0)+i);return{...s,[a]:L}}),w(a)},V=(a,i=1)=>{const s=u.find(L=>L.id===a);s&&(We({id:s.id,product:s.name,store:d.name,storeId:d.id,categoryId:s.categoryId,price:s.price,saleUnit:s.saleUnit,tamano:s.tamano},i),ge(a,i))};return o.jsxs(ve,{showSearch:!1,children:[o.jsx(A,{children:o.jsx(E,{children:o.jsx(ha,{id:d.id,name:d.name,category:d.category,categoryId:d.id,address:d.address,hours:d.hours,distanceKm:d.distanceKm,rating:d.rating,openNow:d.openNow,minOrder:d.minOrder})})}),o.jsx(A,{children:o.jsx(E,{children:o.jsxs(Ia,{children:[p?o.jsxs(ka,{children:[o.jsx(Qe,{size:20,"aria-hidden":"true"}),o.jsxs(Ca,{children:[o.jsxs(Sa,{children:["Productos del pedido ",p.code]}),o.jsxs(za,{children:[p.date," · ",q(p.total)]})]}),o.jsx(Pa,{type:"button",onClick:ce,children:"Ver todo el comercio"})]}):null,o.jsx(ke,{onSubmit:pe,children:o.jsxs(Ce,{htmlFor:"store-search",children:[o.jsx(Se,{children:"Buscar productos dentro del comercio"}),o.jsxs(ze,{children:[o.jsx(Ve,{size:18,"aria-hidden":"true"}),o.jsx(Pe,{id:"store-search",value:y,onChange:a=>z(a.target.value),placeholder:`Buscar en ${d.name}...`,"aria-label":"Buscar productos dentro del comercio"})]})]})}),o.jsxs(Y,{"aria-label":"Categorías del comercio",children:[o.jsx(oe,{type:"button","data-active":t==="all",onClick:()=>g("all"),children:"Todas"}),m.sections.map(a=>o.jsx(oe,{type:"button","data-active":t===a.id,onClick:()=>g(a.id),children:a.label},a.id))]}),I.length>0?I.map((a,i)=>o.jsxs(Le,{ref:a.id===ne?R:void 0,children:[o.jsx(G,{title:a.label,subtitle:a.description}),o.jsx(qa,{children:a.products.map((s,L)=>o.jsx(K,{name:s.name,price:s.price,saleUnit:s.saleUnit,categoryId:s.categoryId,badge:p?`${v[s.id]??1} u.`:s.badge,quantity:C[s.id]??0,onAdd:me=>V(s.id,me),priority:i===0&&L<4},s.id))})]},a.id)):o.jsx(Ie,{icon:_e,title:"Sin resultados",text:"Probá con otro término o cambiá de categoría.",dashed:!0})]})})}),U.length>0&&o.jsx(A,{children:o.jsxs(E,{children:[o.jsx(G,{title:"También podés llevar",chip:"Sugeridos",subtitle:"Combinaciones que van con lo que estás pidiendo."}),o.jsx(Y,{as:qe,"aria-label":"Productos sugeridos",children:U.map(a=>o.jsx(K,{name:a.name,price:a.price,categoryId:a.categoryId,badge:a.badge,quantity:C[a.id]??0,onAdd:i=>V(a.id,i)},a.id))})]})}),P>0&&o.jsx(xa,{style:{height:le}}),P>0&&o.jsxs(ya,{ref:D,children:[o.jsxs($a,{children:[o.jsxs(wa,{children:[P," ",P===1?"producto":"productos"]}),o.jsx(ja,{children:q(de)})]}),o.jsxs(va,{to:"/carrito",children:[o.jsx(Ye,{size:18,"aria-hidden":"true"}),"Ver carrito"]})]})]})}r.span`
  display: inline-flex;
  align-items: center;
  min-height: 1.5rem;
  ...
  text-transform: uppercase;
`;function Ba(e,n,c){if(!e)return!0;const x=e.toLowerCase();return[n.label,n.description,c.name,c.description,c.categoryLabel].join(" ").toLowerCase().includes(x)}export{Ra as StoreProfileScreen};
