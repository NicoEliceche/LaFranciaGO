const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AddressMap-B7jSB8uF.js","assets/react-D_B_6qYb.js","assets/AddressMapStyled-icnVTwhH.js","assets/AddressMapStyled-CIGW-MKW.css","assets/useCurrentPosition-BYw6bfYw.js","assets/AuthScreen-B7XpcGsN.js","assets/formStyles-DG_tTv25.js","assets/AuthScreenStyled-HWbOxme_.js","assets/PanelLoginDialogStyled-BhhxZ6L3.js","assets/mail-B04ACwjO.js","assets/shield-check-BEFpahNm.js","assets/log-in-DEWe4hri.js","assets/RecuperarScreen-CaemyHyZ.js","assets/CategoriesScreen-Bakwkqax.js","assets/StoresDirectoryScreen-CKnnC_Go.js","assets/StoreProfileScreen-Cwf1VbN_.js","assets/saleUnits-CLP-TCsg.js","assets/cartStore-BrnRW5uM.js","assets/clock-3-ClxBJ32x.js","assets/ProductDetailScreen-Bcq85FoX.js","assets/SettingsList-DnvHvdZV.js","assets/MyOrdersScreen-CT5i9K8t.js","assets/CartScreen-Bd6yH4tX.js","assets/ConfirmDialog-B447XHGP.js","assets/credit-card-CrnS20C2.js","assets/wallet-D7OdK-nk.js","assets/ErrandScreen-Db0okDip.js","assets/errandStore-Bion9qKH.js","assets/ErrandChatScreen-CsMZzUsG.js","assets/mediaService-D2_VAu2k.js","assets/camera-CC26teVQ.js","assets/send-2nrINtwp.js","assets/FavoritesScreen-B7p5qFA4.js","assets/NotificationsScreen-BNjFv6Fy.js","assets/message-square-BEkOO-F_.js","assets/badge-percent-Do5XH75M.js","assets/CustomerAccountScreen-D1CV-nNp.js","assets/phone-BNx6nfqO.js","assets/CommerceRegistrationScreen-JP8uiweA.js","assets/useMediaUpload-CTMFYLii.js","assets/FileField-DZY4u31q.js","assets/ProductFormScreenStyled-CEl5wYvE.js","assets/DeliveryRegistrationScreen-s8XEx9jN.js","assets/MiComercioScreen-DPHUSbaC.js","assets/ChatPedidoDialog-BWTAqCa4.js","assets/bar-chart-3-C4XtQlzX.js","assets/CommercePanelScreen-wKjh0rIN.js","assets/MetricTile-pqsdYhTD.js","assets/ProductFormScreen-Czjo9BkS.js","assets/PanelRepartidorScreen-B1lE_cBf.js","assets/refresh-cw-Ck9m7Q3O.js","assets/DeliveryPanelScreen-DU5KpUqt.js","assets/AdminPostulacionesScreen-DC4_kEiq.js","assets/AdminPanelScreen-DUxblgg-.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Eo=P("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function zo({size:e=18,...r}){return t.jsxs("svg",{...r,width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",focusable:"false",children:[t.jsx("path",{d:"M1.5 10.5h4"}),t.jsx("path",{d:"M3 14h3.5"}),t.jsx("circle",{cx:"10.5",cy:"17",r:"3"}),t.jsx("circle",{cx:"19.5",cy:"17",r:"3"}),t.jsx("path",{d:"M10.5 17h2.2l2.1-4.2h3.1l1.6 3.4"}),t.jsx("path",{d:"M14.4 12.8l1.2-2h2.6"}),t.jsx("path",{d:"M17.4 8.2h2.6"})]})}const xt="lafranciago:foto-perfil",fr=new Set;let Ue=null,ha=!1;const On=()=>fr.forEach(e=>e()),Po=e=>/^data:image\/(png|jpeg|webp);base64,[A-Za-z0-9+/=]+$/.test(e),Nn=()=>{try{const e=window.localStorage.getItem(xt);return e&&Po(e)?e:null}catch{return null}};function ga(e){if(!(e!==null&&!Po(e))){Ue=e;try{e?window.localStorage.setItem(xt,e):window.localStorage.removeItem(xt)}catch{try{window.localStorage.removeItem(xt)}catch{}}On()}}function Dn(){const[e,r]=p.useState(Ue);p.useEffect(()=>{ha||(ha=!0,Ue=Nn()),r(Ue);const i=()=>r(Ue);return fr.add(i),()=>{fr.delete(i)}},[]);const a=p.useCallback(()=>ga(null),[]);return{photo:e,setPhoto:ga,clearPhoto:a}}const Bn="https://photon.komoot.io/api/",Hn="https://nominatim.openstreetmap.org/reverse",yr={lat:-31.4063691,lon:-62.6332043},rr=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,""),qn=e=>[e.street??e.name,e.housenumber].filter(Boolean).join(" ")||e.name||"Sin nombre",Gn=e=>[e.city??e.county,e.state,e.country].filter(Boolean).join(", ");async function Yn(e,r){const a=e.trim();if(a.length<2)return[];const i=new URLSearchParams({q:a,limit:"12",lat:String(yr.lat),lon:String(yr.lon)});try{const n=await fetch(`${Bn}?${i.toString()}`,{signal:r});return n.ok?((await n.json()).features??[]).map((s,d)=>{var h;const m=s.properties??{},[g,b]=((h=s.geometry)==null?void 0:h.coordinates)??[];return typeof b!="number"||typeof g!="number"?null:{id:`${m.type??"geo"}-${d}-${b}-${g}`,label:qn(m),context:Gn(m),lat:b,lon:g}}).filter(s=>s!==null).sort((s,d)=>{const m=rr(a),g=rr(s.label).startsWith(m),b=rr(d.label).startsWith(m);return g!==b?g?-1:1:0}).slice(0,6):[]}catch{return[]}}async function Vn(e,r,a){const i=new URLSearchParams({format:"json",lat:String(e),lon:String(r),zoom:"18","accept-language":"es"});try{const n=await fetch(`${Hn}?${i.toString()}`,{signal:a});if(!n.ok)return null;const s=(await n.json()).address??{};return[s.road,s.house_number].filter(Boolean).join(" ")||s.neighbourhood||s.city||null}catch{return null}}const Un=[{id:"home",label:"Casa",address:"Av. San Martín 123",primary:!0},{id:"work",label:"Trabajo",address:"Ruta 19 km 115",primary:!1}],Ro="https://lafranciago-api.lafranciago-api.workers.dev",we=()=>Ro.length>0;class Mo extends Error{constructor(r,a){super(r),this.status=a,this.name="ApiError"}}async function st(e,r={}){const a=await fetch(`${Ro}${e}`,{...r,credentials:"include",headers:{...r.body instanceof FormData?{}:{"Content-Type":"application/json"},...r.headers}});if(!a.ok){const i=await a.json().then(n=>n.error).catch(()=>null);throw new Mo(i??`Error ${a.status}`,a.status)}return a.json()}const A={get:e=>st(e),post:(e,r)=>st(e,{method:"POST",body:r instanceof FormData?r:JSON.stringify(r??{})}),patch:(e,r)=>st(e,{method:"PATCH",body:JSON.stringify(r??{})}),delete:e=>st(e,{method:"DELETE"})},Re={registro:e=>A.post("/auth/registro",e),login:e=>A.post("/auth/login",e),loginPanel:e=>A.post("/auth/login-panel",e),logout:()=>A.post("/auth/logout"),yo:()=>A.get("/auth/yo"),recuperar:e=>A.post("/auth/recuperar",{email:e}),confirmarRecuperacion:(e,r)=>A.post("/auth/recuperar/confirmar",{token:e,password:r}),cambiarRol:e=>A.post("/auth/rol",{rol:e})},Gp={crear:(e,r)=>A.post("/postulaciones",{rol:e,datos:r}),mias:()=>A.get("/postulaciones/mias")},Yp={postulaciones:(e="pendiente")=>A.get(`/admin/postulaciones?estado=${e}`),revisar:(e,r,a)=>A.post(`/admin/postulaciones/${e}`,{decision:r,nota:a}),metricas:()=>A.get("/admin/metricas"),actualizarComercio:(e,r)=>A.patch(`/admin/comercios/${e}`,r)},Wn={listar:(e={})=>{const r=new URLSearchParams;e.rubro&&r.set("rubro",e.rubro),e.q&&r.set("q",e.q);const a=r.toString();return A.get(`/comercios${a?`?${a}`:""}`)},detalle:e=>A.get(`/comercios/${e}`),crear:e=>A.post("/comercios",e)},Kn={portada:()=>A.get("/ofertas")},Vp={ver:()=>A.get("/mi-comercio"),crearProducto:e=>A.post("/productos",e),editarProducto:(e,r)=>A.patch(`/productos/${e}`,r),borrarProducto:e=>A.delete(`/productos/${e}`),ofertas:()=>A.get("/mi-comercio/ofertas"),metricas:()=>A.get("/mi-comercio/metricas"),fraccionamientos:()=>A.get("/mi-comercio/fraccionamientos"),resolverFraccionamiento:(e,r)=>A.post(`/mi-comercio/fraccionamientos/${e}`,{decision:r}),crearOferta:e=>A.post("/mi-comercio/ofertas",e),borrarOferta:e=>A.delete(`/mi-comercio/ofertas/${e}`),activarOferta:(e,r)=>A.patch(`/mi-comercio/ofertas/${e}`,{activa:r})},Up={pedidos:e=>A.get(`/mi-comercio/pedidos${e?`?estado=${e}`:""}`),envios:()=>A.get("/mi-comercio/envios"),mensajes:e=>A.get(`/pedidos/${e}/mensajes`),enviarMensaje:(e,r)=>A.post(`/pedidos/${e}/mensajes`,{texto:r})},Wp={disponibles:(e,r)=>{const a=new URLSearchParams;typeof e=="number"&&typeof r=="number"&&(a.set("lat",String(e)),a.set("lon",String(r)));const i=a.toString();return A.get(`/delivery/disponibles${i?`?${i}`:""}`)},detalle:e=>A.get(`/delivery/pedidos/${e}`),tomar:(e,r,a)=>A.post(`/delivery/pedidos/${e}/tomar`,{lat:r,lon:a}),actualizarUbicacion:(e,r)=>A.post("/delivery/ubicacion",{lat:e,lon:r}),misEnvios:()=>A.get("/delivery/mis-envios"),avanzar:(e,r)=>A.post(`/delivery/envios/${e}/estado`,{estado:r}),verVehiculo:()=>A.get("/delivery/vehiculo"),elegirVehiculo:(e,r)=>A.post("/delivery/vehiculo",{vehiculo:e,rol:r}),pedirFraccionar:(e,r,a)=>A.post(`/delivery/pedidos/${e}/fraccionar`,{partes:r,motivo:a})},Kp={listar:()=>A.get("/pedidos"),crear:e=>A.post("/pedidos",e)},_o={listar:()=>A.get("/direcciones"),crear:e=>A.post("/direcciones",e)},Xp={moto:"Moto",auto:"Auto",camioneta:"Camioneta",camion:"Camión"},Io={listar:()=>A.get("/notificaciones"),marcarLeidas:e=>A.post("/notificaciones/leidas",{ids:e??[]})},Zp={iniciar:e=>A.post(`/pedidos/${e}/pagar`),estado:e=>A.get(`/pedidos/${e}/pago`),conectarComercio:()=>A.get("/pagos/conectar")},br={listar:()=>A.get("/favoritos"),agregar:e=>A.post(`/favoritos/${e}`),quitar:e=>A.delete(`/favoritos/${e}`)},Jp={subir:(e,r)=>{const a=new FormData;return a.append("archivo",e,r),A.post("/media",a)}},xr=new Set;let wr=[],Oe="inicial";const fa=()=>xr.forEach(e=>e());async function Fo(){if(Oe==="inicial"){if(Oe="cargando",!we()){Oe="listo",fa();return}try{const{direcciones:e}=await _o.listar();wr=e.map(r=>({id:r.id,label:r.etiqueta,address:r.direccion,primary:r.es_principal===1}))}catch{wr=[]}Oe="listo",fa()}}function To(){return Oe="inicial",Fo()}async function Xn(e){if(!we())return null;const{id:r}=await _o.crear(e);return await To(),r}function Qp(){const[,e]=p.useState(0);p.useEffect(()=>{const a=()=>e(i=>i+1);return xr.add(a),Fo(),()=>{xr.delete(a)}},[]);const r=p.useCallback(()=>To(),[]);return{direcciones:wr,cargando:Oe!=="listo",recargar:r}}const Zn=Xt`
  from { opacity: 0; }
  to { opacity: 1; }
`,Jn=Xt`
...
`,yt=4,Xd=6,Zd=420,Jd=.91,Qd=.2,ep=.45,tp=260,rp=e=>1-(1-e)**3;function cr({children:e,className:r,as:a,...i}){const n=p.useRef(null),c=p.useRef(null),s=p.useRef(null),[d,m]=p.useState(!1),[g,b]=p.useState(!1),h=p.useCallback(()=>{const y=n.current;if(!y)return;const{scrollLeft:x,scrollWidth:v,clientWidth:R}=y;m(x>yt),b(x+R<v-yt)},[]);p.useLayoutEffect(()=>{h()},[h,e]),p.useEffect(()=>{var v;const y=n.current;if(!y)return;const x=((v=window.matchMedia)==null?void 0:v.call(window,"(pointer: fine)").matches)??!1;y.style.cursor=x&&(d||g)?"grab":""},[d,g]),p.useEffect(()=>{var R;const y=n.current;if(!y)return;const x=M=>{const z=y.scrollWidth-y.clientWidth;if(z<=0)return;const O=Math.abs(M.deltaX)>Math.abs(M.deltaY)?M.deltaX:M.deltaY;if(O===0)return;const Z=O>0?1:-1,Y=y.scrollLeft<=yt,V=y.scrollLeft>=z-yt;if(Z<0&&Y||Z>0&&V)return;M.preventDefault();const ae=s.current??y.scrollLeft,U=Math.max(0,Math.min(ae+Z*tp,z));j(y,U)};y.addEventListener("wheel",x,{passive:!1}),y.addEventListener("scroll",h,{passive:!0}),y.addEventListener("scrollend",h,{passive:!0});const v=typeof ResizeObserver<"u"?new ResizeObserver(h):null;return v==null||v.observe(y),Array.from(y.children).forEach(M=>v==null?void 0:v.observe(M)),(R=document.fonts)==null||R.ready.then(h).catch(()=>{}),()=>{y.removeEventListener("wheel",x),y.removeEventListener("scroll",h),y.removeEventListener("scrollend",h),v==null||v.disconnect(),c.current!==null&&(cancelAnimationFrame(c.current),c.current=null),s.current=null}},[h]);const E=(y,x)=>{var z;if(c.current!==null&&(cancelAnimationFrame(c.current),c.current=null),s.current=null,Math.abs(x)<ep||(z=window.matchMedia)!=null&&z.call(window,"(prefers-reduced-motion: reduce)").matches){h();return}let v=-x;const R=y.scrollWidth-y.clientWidth,M=()=>{const O=y.scrollLeft+v;if(O<=0||O>=R){y.scrollLeft=O<=0?0:R,c.current=null,h();return}if(y.scrollLeft=O,v*=Jd,h(),Math.abs(v)<Qd){c.current=null;return}c.current=requestAnimationFrame(M)};c.current=requestAnimationFrame(M)},f=y=>{if(y.pointerType!=="mouse"||y.button!==0)return;const x=n.current;if(!x)return;c.current!==null&&(cancelAnimationFrame(c.current),c.current=null),s.current=null;const v=y.clientX,R=x.scrollLeft;let M=!1,z=0,O=y.clientX,Z=performance.now();const Y=U=>U.preventDefault();x.addEventListener("dragstart",Y);const V=U=>{const N=U.clientX-v;if(!M){if(Math.abs(N)<Xd)return;M=!0,x.style.scrollBehavior="auto",x.style.cursor="grabbing",x.style.userSelect="none"}const oe=performance.now(),Q=oe-Z;if(Q>0){const C=(U.clientX-O)/Q*16;z=z*.7+C*.3,O=U.clientX,Z=oe}x.scrollLeft=R-N},ae=()=>{if(document.removeEventListener("pointermove",V),document.removeEventListener("pointerup",ae),document.removeEventListener("pointercancel",ae),x.removeEventListener("dragstart",Y),x.style.scrollBehavior="",x.style.cursor="",x.style.userSelect="",M){E(x,z);const U=N=>{N.stopPropagation(),N.preventDefault()};x.addEventListener("click",U,{capture:!0,once:!0}),window.setTimeout(()=>x.removeEventListener("click",U,{capture:!0}),0)}h()};document.addEventListener("pointermove",V),document.addEventListener("pointerup",ae),document.addEventListener("pointercancel",ae)},j=(y,x)=>{var O;c.current!==null&&(cancelAnimationFrame(c.current),c.current=null);const v=y.scrollLeft,R=x-v;if(Math.abs(R)<1){s.current=null;return}if(s.current=x,(O=window.matchMedia)!=null&&O.call(window,"(prefers-reduced-motion: reduce)").matches){y.scrollLeft=x,s.current=null,h();return}const M=performance.now(),z=Z=>{const Y=Z-M,V=Math.min(Y/Zd,1);if(y.scrollLeft=v+R*rp(V),h(),V<1){c.current=requestAnimationFrame(z);return}c.current=null,s.current=null};c.current=requestAnimationFrame(z)},I=y=>{const x=n.current;if(!x)return;const v=x.scrollWidth-x.clientWidth,R=x.scrollLeft+y*x.clientWidth*.7;j(x,Math.max(0,Math.min(R,v)))};return t.jsxs(Wd,{className:r,children:[d?t.jsx(Ga,{type:"button","data-side":"left",onClick:()=>I(-1),"aria-label":"Ver filtros anteriores",tabIndex:-1,children:t.jsx(fo,{size:16,"aria-hidden":"true"})}):null,a?t.jsx(a,{ref:n,onPointerDown:f,...i,children:e}):t.jsx(Kd,{ref:n,onPointerDown:f,...i,children:e}),g?t.jsx(Ga,{type:"button","data-side":"right",onClick:()=>I(1),"aria-label":"Ver más filtros",tabIndex:-1,children:t.jsx(Ge,{size:16,"aria-hidden":"true"})}):null]})}const Uo="lafranciago:orden",ap=["relevancia","cercania","precio","puntuacion","entrega"],op=()=>{try{const e=window.localStorage.getItem(Uo);return ap.includes(e)?e:"relevancia"}catch{return"relevancia"}};function ip(){const[e,r]=p.useState("relevancia");p.useEffect(()=>{r(op())},[]);const a=p.useCallback(i=>{r(i);try{window.localStorage.setItem(Uo,i)}catch{}},[]);return{sortMode:e,setSortMode:a}}const np=o(be)`
  display: flex;
  align-items: center;
  gap: ${({theme:e})=>e.spacing[3]};
  padding: ${({theme:e})=>e.spacing[3]};
