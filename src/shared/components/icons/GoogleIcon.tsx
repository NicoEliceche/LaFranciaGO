/**
 * Logo de Google con sus cuatro colores.
 *
 * Va con los colores oficiales y no en el tono de la app: las guías de marca
 * de Google lo exigen, y además la gente reconoce el botón por el color.
 */
